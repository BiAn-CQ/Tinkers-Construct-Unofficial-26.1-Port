...
public final class TinkerGadgets extends TinkerModule {
   ...
   * Items
   */
  public static final ItemObject<PiggyBackPackItem> piggyBackpack = ITEMS.register("piggy_backpack", () -> new PiggyBackPackItem(itemProperties().stacksTo(16)));
  public static final EnumObject<FrameType,FancyItemFrameItem> itemFrame = ITEMS.registerEnum(FrameType.values(), "item_frame", (type) -> new FancyItemFrameItem(itemProperties(ITEM_PROPS), (world, pos, dir) -> new FancyItemFrameEntity(world, pos, dir, type)));
  public static final EnumObject<StandType,FancyArmorStandItem> armorStand = ITEMS.registerEnum(StandType.values(), "armor_stand", type -> new FancyArmorStandItem(itemProperties(ITEM_PROPS).stacksTo(16), type));
  ...
  static {
    Item.Properties THROWABLE_PROPS = itemProperties().stacksTo(16);
    glowBall = ITEMS.register("glow_ball", () -> new GlowBallItem(itemProperties(THROWABLE_PROPS)));
    efln = ITEMS.register("efln_ball", () -> new EFLNItem(itemProperties(THROWABLE_PROPS)));
    quartzShuriken = ITEMS.register("quartz_shuriken", () -> new ShurikenItem(itemProperties(THROWABLE_PROPS), QuartzShurikenEntity::new));
    flintShuriken = ITEMS.register("flint_shuriken", () -> new ShurikenItem(itemProperties(THROWABLE_PROPS), FlintShurikenEntity::new));
   ...
   * Entities
   */
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<FancyItemFrameEntity>> itemFrameEntity = ENTITIES.register("fancy_item_frame", () ->
  ...
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<FancyArmorStandEntity>> armorStandEntity = ENTITIES.register("armor_stand", () ->
    EntityType.Builder.<FancyArmorStandEntity>of(FancyArmorStandEntity::new, MobCategory.MISC)
      .sized(0.5F, 1.975F)
      .setTrackingRange(10));
  @Deprecated
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<GlowballEntity>> glowBallEntity = ENTITIES.register("glow_ball", () ->
  ...
  @Deprecated
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<EFLNEntity>> eflnEntity = ENTITIES.register("efln_ball", () ->
    EntityType.Builder.<EFLNEntity>of(EFLNEntity::new, MobCategory.MISC)
      ...
      .setShouldReceiveVelocityUpdates(true));
  @Deprecated
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<QuartzShurikenEntity>> quartzShurikenEntity = ENTITIES.register("quartz_shuriken", () ->
  ...
  @Deprecated
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<FlintShurikenEntity>> flintShurikenEntity = ENTITIES.register("flint_shuriken", () ->
   ...
   * Potions
   */
  public static final DeferredHolder<MobEffect, ? extends CarryPotionEffect> carryEffect = MOB_EFFECTS.register("carry", CarryPotionEffect::new);
