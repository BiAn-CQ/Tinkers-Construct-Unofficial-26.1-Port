...
public class SlimeGrassBlock extends GrassBlock implements BonemealableBlock {
  @Getter
  ...
  private static boolean isValidPos(BlockState targetState, LevelReader world, BlockPos pos) {
    ...
    return LightEngine.getLightBlockInto(targetState, aboveState, Direction.UP, aboveState.getLightDampening()) < 15;
  }
