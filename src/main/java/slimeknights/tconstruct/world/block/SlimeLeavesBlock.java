...
public class SlimeLeavesBlock extends LeavesBlock {
  public static final MapCodec<SlimeLeavesBlock> CODEC = BlockBehaviour.simpleCodec(properties -> new SlimeLeavesBlock(properties, FoliageType.EARTH));
  ...
  protected void spawnFallingLeavesParticle(Level level, BlockPos pos, RandomSource random) {
    // Slime foliage intentionally has no vanilla falling-leaf particle.
  }
