...
public class TinkerEffects extends TinkerModule {
  ...
  // slimy cakes
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> bouncy = MOB_EFFECTS.register("bouncy", () -> new TinkerEffect(MobEffectCategory.BENEFICIAL, 0x71AC63, true).addAttributeModifier(TinkerAttributes.BOUNCY, TConstruct.getResource("5de036ed-bc47-4965-9348-64c3ab5c8ae8"), 1, Operation.ADD_VALUE));
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> doubleJump = MOB_EFFECTS.register("double_jump", () -> new TinkerEffect(MobEffectCategory.BENEFICIAL, 0xA99B87, true).addAttributeModifier(TinkerAttributes.JUMP_COUNT, TConstruct.getResource("9863601a-9d4a-4708-b348-4bf9fe6c0bbd"), 1, Operation.ADD_VALUE));
  public static final DeferredHolder<MobEffect, ? extends AntigravityEffect> antigravity = MOB_EFFECTS.register("antigravity", AntigravityEffect::new);
  public static final DeferredHolder<MobEffect, ? extends ReturningEffect> returning = MOB_EFFECTS.register("returning", ReturningEffect::new);

  // modifier effects
  public static final DeferredHolder<MobEffect, ? extends BleedingEffect> bleeding = MOB_EFFECTS.register("bleeding", BleedingEffect::new);
  public static final DeferredHolder<MobEffect, ? extends MagneticEffect> magnetic = MOB_EFFECTS.register("magnetic", MagneticEffect::new);
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> selfDestructing = MOB_EFFECTS.register("self_destructing", SelfDestructiveEffect::new);
  public static final DeferredHolder<MobEffect, ? extends RepulsiveEffect> repulsive = MOB_EFFECTS.register("repulsive", RepulsiveEffect::new);
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> pierce = MOB_EFFECTS.register("pierce", () -> new TinkerEffect(MobEffectCategory.HARMFUL, 0xD1D37A, true).addAttributeModifier(Attributes.ARMOR, TConstruct.getResource("cd45be7c-c86f-4a7e-813b-42a44a054f44"), -1, Operation.ADD_VALUE));
  // damage boost
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> conductive = MOB_EFFECTS.register("conductive", () -> new TinkerEffect(MobEffectCategory.HARMFUL, 0xF2D500, true));
  public static final DeferredHolder<MobEffect, ? extends TinkerEffect> venom = MOB_EFFECTS.register("venom", () -> new TinkerEffect(MobEffectCategory.HARMFUL, 0xA2935E, true));
  ...
  public TinkerEffects() {
    POTIONS.register(net.neoforged.fml.ModLoadingContext.get().getActiveContainer().getEventBus());
  ...
  private static void brewing(PotionBrewing.Builder builder, EnumObject<PotionType,Potion> potion, net.minecraft.core.Holder<Potion> base, Item ingredient) {
    Potion normal = potion.get(PotionType.NORMAL);
    net.minecraft.core.Holder<Potion> normalHolder = BuiltInRegistries.POTION.wrapAsHolder(normal);
