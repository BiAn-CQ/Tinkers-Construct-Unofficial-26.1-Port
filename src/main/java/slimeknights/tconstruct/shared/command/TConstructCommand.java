...
public class TConstructCommand {
  ...
  public static void init() {
    ARGUMENT_TYPE.register(net.neoforged.fml.ModLoadingContext.get().getActiveContainer().getEventBus());
  ...
  private static void registerCommand(RegisterCommandsEvent event) {
    ...
    register(builder, "generate", b -> {
      ...
      register(b, "melting_recipes", command -> GenerateMeltingRecipesCommand.register(command, context));
