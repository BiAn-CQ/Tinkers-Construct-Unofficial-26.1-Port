...
public interface ICastCreationHelper extends IRecipeHelper {
  Identifier SAND_CAST_KEY = TConstruct.getResource("sand_cast");
  ...
  default void castCreation(RecipeOutput consumer, TagKey<Item> input, CastItemObject cast, String folder) {
    castCreation(consumer, TinkerIngredients.of(input), cast, folder, input.location().getPath());
  }
  ...
  default void castCreation(RecipeOutput consumer, Ingredient input, CastItemObject cast, String folder, String name) {
    ...
    ItemPartRecipeBuilder.item(pattern, ItemOutput.fromItem(cast.getSand()))
      ...
      .setPatternItem(slimeknights.tconstruct.library.recipe.TinkerIngredients.of(TinkerTags.Items.SAND_CASTS))
    ...
    ItemPartRecipeBuilder.item(pattern, ItemOutput.fromItem(cast.getRedSand()))
      .setTitleKey(SAND_CAST_KEY)
      .setPatternItem(slimeknights.tconstruct.library.recipe.TinkerIngredients.of(TinkerTags.Items.RED_SAND_CASTS))
    ...
    ItemPartRecipeBuilder.item(pattern, ItemOutput.fromItem(cast.getSand(), 4))
      .setTitleKey(SAND_CAST_KEY)
      .setPatternItem(slimeknights.tconstruct.library.recipe.TinkerIngredients.of(Tags.Items.SANDS_COLORLESS))
    ...
    ItemPartRecipeBuilder.item(pattern, ItemOutput.fromItem(cast.getRedSand(), 4))
      .setTitleKey(SAND_CAST_KEY)
      .setPatternItem(slimeknights.tconstruct.library.recipe.TinkerIngredients.of(Tags.Items.SANDS_RED))
