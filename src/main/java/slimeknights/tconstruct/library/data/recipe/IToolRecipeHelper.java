...
public interface IToolRecipeHelper extends ICastCreationHelper {
   ...
   */
  default void toolBuilding(RecipeOutput consumer, IModifiable tool, String folder, Identifier layoutSlot) {
    ToolBuildingRecipeBuilder.toolBuildingRecipe(tool)
  ...
  default void partCasting(RecipeOutput consumer, IMaterialItem part, CastItemObject cast, int cost, String partFolder, String castFolder) {
    ...
    // Cast Casting
    castCreation(consumer, MaterialTinkerIngredients.of(part), cast, castFolder, id(part).getPath());
  }
  ...
  default void uncastablePart(RecipeOutput consumer, IMaterialItem part, int cost, @Nullable MaterialStatsId castingStatConflict, String partFolder) {
    ...
    PartRecipeBuilder.partRecipe(part)
                     .setPattern(id)
                     .setPatternItem(TinkerIngredients.of(TinkerTags.Items.DEFAULT_PATTERNS))
                     .setCost(cost)
  ...
  default void partWithDummy(RecipeOutput consumer, IMaterialItem part, ItemLike dummyPart, CastItemObject cast, int cost, String partFolder, String castFolder) {
    ...
    partCasting(consumer, part, cast, cost, partFolder);
    // Cast Casting
    castCreation(consumer, CompoundIngredient.of(TinkerIngredients.of(dummyPart), MaterialTinkerIngredients.of(part)), cast, castFolder, id(part).getPath());
    ...
    ItemPartRecipeBuilder.item(cast.getName(), ItemOutput.fromItem(dummyPart))
                         ...
                         .setPatternItem(CompoundIngredient.of(TinkerIngredients.of(TinkerTags.Items.DEFAULT_PATTERNS), TinkerIngredients.of(cast.get())))
