...
public final class ToolBuildHandler {
  ...
  public static ItemStack buildToolForRendering(Item item, ToolDefinition definition) {
    ...
    ItemStackDataUtil.updateTag(stack, tag -> tag.putBoolean(TooltipUtil.KEY_DISPLAY, true));
    return stack;
  }
  ...
  public static ItemStack getDisplayPart(IToolPart toolPart, int i) {
    ...
    ItemStackDataUtil.updateTag(item, tag -> tag.putBoolean(TooltipUtil.KEY_DISPLAY, true));
    return item;
  }
