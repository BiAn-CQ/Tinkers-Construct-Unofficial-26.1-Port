...
public class ArmorUtil {
  ...
  private static final Identifier DIAMOND_ARMOR = Identifier.withDefaultNamespace("textures/models/armor/diamond_layer_1.png");
  private static final Identifier DIAMOND_LEGGINGS = Identifier.withDefaultNamespace("textures/models/armor/diamond_layer_2.png");
   ...
   */
  public static Identifier getDummyArmorTexture(EquipmentSlot slot) {
