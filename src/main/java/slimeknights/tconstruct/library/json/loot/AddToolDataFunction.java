...
public class AddToolDataFunction extends LootItemConditionalFunction {
  ...
  private static final Codec<RandomMaterial> MATERIAL_CODEC = new LoadableCodec<>(RandomMaterial.LOADER);
  public static final MapCodec<AddToolDataFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> commonFields(instance).and(instance.group(
    Codec.floatRange(0, 1).optionalFieldOf("damage", 0.0f).forGetter(function -> function.damage),
    MATERIAL_CODEC.listOf().optionalFieldOf("materials", List.of()).forGetter(function -> function.materials)
