...
public abstract class AbstractMaterialRenderInfoProvider extends GenericDataProvider {
  ...
  private RenderInfoBuilder getBuilder(@Nullable Identifier texture) {
    ...
    if (materialSprites != null && texture != null) {
      ...
      if (spriteInfo != null) {
        ...
        // NativeImage and sprite transformers use ARGB on this platform.
  ...
  protected static class RenderInfoBuilder {
    ...
    public RenderInfoBuilder texture(@Nullable Identifier texture) { this.texture = texture; return this; }
    public RenderInfoBuilder parent(@Nullable Identifier parent) { this.parent = parent; return this; }
