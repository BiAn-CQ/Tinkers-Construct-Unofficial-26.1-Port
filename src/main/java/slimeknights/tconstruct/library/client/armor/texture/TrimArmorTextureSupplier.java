...
public record TrimArmorTextureSupplier(ModifierId modifier, Identifier patternKey, Identifier materialKey) implements ArmorTextureSupplier {
  ...
  public static class TrimArmorTexture implements ArmorTexture {
    ...
    private static ArmorTexture create(Identifier root, TrimMaterial material, boolean decal) {
      ...
      TConstruct.LOG.error("Missing material specific texture {}, defaulting to tinting base texture #{}", withMaterial, ColorLoadable.NO_ALPHA.getStringOr(color, ""));
