...
public final class FluidMobEffect {
  ...
  public FluidMobEffect(Identifier effect, int time, int level) {
  ...
  private Holder<MobEffect> effectHolder() {
    return BuiltInRegistries.MOB_EFFECT.get(effectKey.identifier())
      .orElseThrow(() -> new IllegalStateException("Unknown mob effect " + effectKey.identifier()));
  }
  ...
  public MobEffectInstance effectWithTime(int time) {
    ...
    if (curativeItems != null) {
      slimeknights.tconstruct.library.utils.EffectCureUtil.setCures(instance, curativeItems);
    }
    return instance;
  }
  ...
  public String toString() {
    return "FluidMobEffect[effect=" + effectKey.identifier() + ", time=" + time + ", level=" + level + ", curativeItems=" + curativeItems + ']';
  }
