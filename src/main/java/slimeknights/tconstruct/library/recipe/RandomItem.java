...
public abstract class RandomItem {
  ...
  public static RandomItem read(FriendlyByteBuf buffer) {
    var registryBuffer = TinkerNetworkBuffer.registry(buffer);
    ItemOutput result = ItemOutput.read(registryBuffer);
  ...
  private static class Range extends RandomItem {
    ...
    public ItemStack get(Random random) {
      ...
      return slimeknights.tconstruct.library.utils.ItemStackDataUtil.copyStackWithSize(result, newCount);
    }
    ...
    public void write(FriendlyByteBuf buffer) {
      result.write(TinkerNetworkBuffer.registry(buffer));
