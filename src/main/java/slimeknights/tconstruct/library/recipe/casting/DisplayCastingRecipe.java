...
public final class DisplayCastingRecipe implements IDisplayableCastingRecipe {
  ...
  @Deprecated
  public DisplayCastingRecipe(@Nullable Identifier recipeId, RecipeType<?> type, List<ItemStack> castItems, List<FluidStack> fluids, List<ItemStack> outputs, int coolingTime, boolean consumed) {
  ...
  public static Builder from(net.minecraft.world.item.crafting.RecipeHolder<? extends ICastingRecipe> recipe) {
    return type(recipe.value().getType()).id(recipe.id().identifier());
  }
  ...
  public static class Builder {
    ...
    public IDisplayableCastingRecipe build() {
      // Basin recipes may legitimately have no cast.
