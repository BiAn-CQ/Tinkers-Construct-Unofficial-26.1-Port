...
public class ItemCastingRecipe extends AbstractCastingRecipe implements IDisplayableCastingRecipe {
  ...
  public RecipeSerializer getSerializer() { return serializer.serializer(); }
  ...
  public boolean matches(ICastingContainer inv, Level worldIn) {
    return TinkerIngredients.matches(getCast(), inv.getStack()) && fluid.test(inv.getFluid());
  }
  ...
  public boolean hasCast() {
    return getCast() != TinkerIngredients.EMPTY;
  }

  @Override
  public List<ItemStack> getCastItems() {
    return Arrays.asList(slimeknights.tconstruct.library.recipe.TinkerIngredients.getItems(getCast()));
  }
