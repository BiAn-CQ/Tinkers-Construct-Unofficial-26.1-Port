...
public class MaterialFluidRecipe implements ICustomOutputRecipe<ICastingContainer> {
  ...
  public static final MaterialFluidRecipe EMPTY = new MaterialFluidRecipe(TConstruct.getResource("missingno"), FluidTinkerIngredients.EMPTY, 0, null, IMaterial.UNKNOWN_ID);
