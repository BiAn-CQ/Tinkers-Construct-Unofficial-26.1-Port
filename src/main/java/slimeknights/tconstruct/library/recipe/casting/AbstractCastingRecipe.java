...
public abstract class AbstractCastingRecipe implements ICastingRecipe {
  /* Common fields */
  protected static final LoadableField<Ingredient,AbstractCastingRecipe> CAST_FIELD = IngredientLoadable.ALLOW_EMPTY.defaultField("cast", TinkerIngredients.EMPTY, AbstractCastingRecipe::getCast);
  ...
  public NonNullList<Ingredient> getIngredients() {
    return NonNullList.of(TinkerIngredients.EMPTY, this.cast);
  }
}
