...
public class MaterialValueSwappingRecipe extends MaterialIndexSwappingRecipe implements IMultiRecipe<IDisplayToolTinkering> {
  ...
  @Override
  public RecipeSerializer<MaterialValueSwappingRecipe> getSerializer() {
  ...
  public List<IDisplayToolTinkering> getRecipes(HolderLookup.Provider access) {
    if (multiRecipes == null) {
      ...
      multiRecipes = Arrays.stream(slimeknights.tconstruct.library.recipe.TinkerIngredients.getItems(tools)).<IDisplayToolTinkering>flatMap(tool -> {
