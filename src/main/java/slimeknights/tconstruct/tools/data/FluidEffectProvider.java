...
public class FluidEffectProvider extends AbstractFluidEffectProvider {
  ...
  protected void addFluids() {
      ...
      .addEntityEffects(FluidMobEffect.builder().effect(MobEffects.NAUSEA, 5 * 20, 1).buildEntity(TimeAction.ADD));
    {
      ...
      ResourceKey<MobEffect> flammable = ResourceKey.create(Registries.MOB_EFFECT, Identifier.fromNamespaceAndPath(ie, "flammable"));
      ...
      compatFluid(ie, "biodiesel", 50)
        ...
        .addEntityEffect(new FireFluidEffect(TimeAction.ADD, 8));
      FluidMobEffect conductive = new FluidMobEffect(Identifier.fromNamespaceAndPath(ie, "conductive"), 8 * 20, 2);
      ...
      compatFluid(ie, "phenolic_resin", 50).addEffect(FluidMobEffect.builder().effect(ResourceKey.create(Registries.MOB_EFFECT, Identifier.fromNamespaceAndPath(ie, "sticky")), 8 * 20, 2), TimeAction.ADD);
      Identifier concreteSprayed = Identifier.fromNamespaceAndPath(ie, "concrete_sprayed");
      AreaMobEffectFluidEffect concreteFeet = new AreaMobEffectFluidEffect(new FluidMobEffect(Identifier.fromNamespaceAndPath(ie, "concrete_feet"), MobEffectInstance.INFINITE_DURATION, 1), TimeAction.SET, GroupCost.MAX);
