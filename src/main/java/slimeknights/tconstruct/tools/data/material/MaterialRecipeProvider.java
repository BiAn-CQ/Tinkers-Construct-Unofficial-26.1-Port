...
public class MaterialRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper {
  public MaterialRecipeProvider(net.minecraft.core.HolderLookup.Provider registries, RecipeOutput output) {
  ...
  private void addMaterialItems(RecipeOutput consumer) {
    ...
    // tier 1
    materialRecipe(consumer, MaterialIds.wood,   TinkerIngredients.of(Tags.Items.RODS_WOODEN), 1, 2, folder + "wood/sticks");
    // planks
    materialRecipe(consumer, MaterialIds.crimson,  TinkerIngredients.of(Items.CRIMSON_PLANKS),  1, 1, folder + "wood/planks/crimson");
    materialRecipe(consumer, MaterialIds.warped,   TinkerIngredients.of(Items.WARPED_PLANKS),   1, 1, folder + "wood/planks/warped");
    materialRecipe(withCondition(consumer, TagCombinationCondition.difference(ItemTags.PLANKS, TinkerTags.Items.VARIANT_PLANKS)), MaterialIds.wood,
                   DifferenceIngredient.of(TinkerIngredients.of(ItemTags.PLANKS), TinkerIngredients.of(TinkerTags.Items.VARIANT_PLANKS)), 1, 1, folder + "wood/planks/default");
    // logs
    // standard wood, different recipes just swap the leftovers
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.OAK_LOGS),      4, 1, ItemOutput.fromItem(Blocks.OAK_PLANKS),      folder + "wood/logs/oak");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.SPRUCE_LOGS),   4, 1, ItemOutput.fromItem(Blocks.SPRUCE_PLANKS),   folder + "wood/logs/spruce");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.BIRCH_LOGS),    4, 1, ItemOutput.fromItem(Blocks.BIRCH_PLANKS),    folder + "wood/logs/birch");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.JUNGLE_LOGS),   4, 1, ItemOutput.fromItem(Blocks.JUNGLE_PLANKS),   folder + "wood/logs/jungle");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.DARK_OAK_LOGS), 4, 1, ItemOutput.fromItem(Blocks.DARK_OAK_PLANKS), folder + "wood/logs/dark_oak");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.ACACIA_LOGS),   4, 1, ItemOutput.fromItem(Blocks.ACACIA_PLANKS),   folder + "wood/logs/acacia");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.MANGROVE_LOGS), 4, 1, ItemOutput.fromItem(Blocks.MANGROVE_PLANKS), folder + "wood/logs/mangrove");
    materialRecipe(consumer, MaterialIds.wood, TinkerIngredients.of(ItemTags.CHERRY_LOGS),   4, 1, ItemOutput.fromItem(Blocks.CHERRY_PLANKS),   folder + "wood/logs/cherry");
    // variant wood, swaps the variant as well
    materialRecipe(consumer, MaterialIds.crimson,  TinkerIngredients.of(ItemTags.CRIMSON_STEMS), 4, 1, ItemOutput.fromItem(Blocks.CRIMSON_PLANKS),  folder + "wood/logs/crimson");
    materialRecipe(consumer, MaterialIds.warped,   TinkerIngredients.of(ItemTags.WARPED_STEMS),  4, 1, ItemOutput.fromItem(Blocks.WARPED_PLANKS),   folder + "wood/logs/warped");
    materialRecipe(withCondition(consumer, TagCombinationCondition.difference(ItemTags.LOGS, TinkerTags.Items.VARIANT_LOGS)), MaterialIds.wood,
                   DifferenceIngredient.of(TinkerIngredients.of(ItemTags.LOGS), TinkerIngredients.of(TinkerTags.Items.VARIANT_LOGS)), 4, 1,
                   ItemOutput.fromItem(Items.STICK, 2), folder + "wood/logs/default");
    // bamboo
    materialRecipe(consumer, MaterialIds.bamboo, TinkerIngredients.of(Items.BAMBOO),           1, 9, folder + "wood/bamboo/stick");
    materialRecipe(consumer, MaterialIds.bamboo, TinkerIngredients.of(ItemTags.BAMBOO_BLOCKS), 1, 1, folder + "wood/bamboo/block");
    materialRecipe(consumer, MaterialIds.bamboo, TinkerIngredients.of(Blocks.BAMBOO_PLANKS),   1, 2, folder + "wood/bamboo/planks");
    // stone
    materialRecipe(consumer, MaterialIds.stone,      TinkerIngredients.of(TinkerTags.Items.STONE),      1, 1, folder + "rock/stone");
    materialRecipe(consumer, MaterialIds.andesite,   TinkerIngredients.of(TinkerTags.Items.ANDESITE),   1, 1, folder + "rock/andesite");
    materialRecipe(consumer, MaterialIds.diorite,    TinkerIngredients.of(TinkerTags.Items.DIORITE),    1, 1, folder + "rock/diorite");
    materialRecipe(consumer, MaterialIds.granite,    TinkerIngredients.of(TinkerTags.Items.GRANITE),    1, 1, folder + "rock/granite");
    materialRecipe(consumer, MaterialIds.blackstone, TinkerIngredients.of(TinkerTags.Items.BLACKSTONE), 1, 1, folder + "rock/blackstone");
    materialRecipe(consumer, MaterialIds.calcite,    TinkerIngredients.of(Blocks.CALCITE),              1, 1, folder + "rock/calcite");
    materialRecipe(consumer, MaterialIds.flint,      TinkerIngredients.of(Items.FLINT),                 1, 1, folder + "flint/flint");
    materialRecipe(consumer, MaterialIds.basalt,     TinkerIngredients.of(TinkerTags.Items.BASALT),     1, 1, folder + "flint/basalt");
    materialRecipe(consumer, MaterialIds.deepslate,  TinkerIngredients.of(TinkerTags.Items.DEEPSLATE),  1, 1, folder + "flint/deepslate");
    // copper - want to include oxidized and waxed
    ItemOutput copperIngot = ItemOutput.fromTag(Tags.Items.INGOTS_COPPER);
    materialRecipe(consumer, MaterialIds.copper, TinkerIngredients.of(TinkerTags.Items.NUGGETS_COPPER), 1, 9, folder + "copper/nugget");
    materialRecipe(consumer, MaterialIds.copper, TinkerIngredients.of(Tags.Items.INGOTS_COPPER),        1, 1, folder + "copper/ingot");
    materialRecipe(consumer, MaterialIds.copper, CompoundIngredient.of(TinkerIngredients.of(Tags.Items.STORAGE_BLOCKS_COPPER), TinkerIngredients.of(Blocks.WAXED_COPPER_BLOCK)), 9, 1, copperIngot, folder + "copper/block");
    materialRecipe(consumer, MaterialIds.oxidizedCopper, TinkerIngredients.of(Blocks.EXPOSED_COPPER, Blocks.WEATHERED_COPPER, Blocks.OXIDIZED_COPPER, Blocks.WAXED_EXPOSED_COPPER, Blocks.WAXED_WEATHERED_COPPER, Blocks.WAXED_OXIDIZED_COPPER), 9, 1, copperIngot, folder + "copper/oxidized");
    // other tier 1
    materialRecipe(consumer, MaterialIds.bone,         TinkerIngredients.of(TinkerTags.Items.BONES),    1, 1, folder + "bone");
    materialRecipe(consumer, MaterialIds.chorus,       TinkerIngredients.of(Items.POPPED_CHORUS_FRUIT), 1, 1, folder + "chorus_popped");
    // tier 1 binding
    materialRecipe(consumer, MaterialIds.string,  TinkerIngredients.of(Tags.Items.STRINGS),  1, 4, folder + "string");
    materialRecipe(consumer, MaterialIds.leather, TinkerIngredients.of(Tags.Items.LEATHERS), 1, 1, folder + "leather");
    materialRecipe(consumer, MaterialIds.leather, TinkerIngredients.of(Items.RABBIT_HIDE),  1, 2, folder + "rabbit_hide");
    materialRecipe(consumer, MaterialIds.vine,    TinkerIngredients.of(Items.VINE),         1, 1, folder + "vine");
    materialRecipe(consumer, MaterialIds.cactus,  TinkerIngredients.of(Blocks.CACTUS),      1, 1, folder + "cactus");
    materialRecipe(consumer, MaterialIds.feather, TinkerIngredients.of(Items.FEATHER),      1, 1, folder + "feather");
    materialRecipe(consumer, MaterialIds.paper,   TinkerIngredients.of(Items.PAPER),        1, 1, folder + "paper");
    materialRecipe(consumer, MaterialIds.leaves,  TinkerIngredients.of(ItemTags.LEAVES),    1, 1, folder + "leaves");
    // tier 1 wool
    for (DyeColor color : DyeColor.values()) {
      String name = color.getName();
      materialRecipe(consumer, MaterialVariantId.create(MaterialIds.wool, name), TinkerIngredients.of(SheepShearingRecipe.WOOL_BY_COLOR.get(color)), 1, 1, folder + "wool/" + name);
    }
    ...
    materialRecipe(consumer, MaterialIds.searedStone,   TinkerIngredients.of(TinkerSmeltery.searedBrick),       1, 1, folder + "seared_stone/brick");
    materialRecipe(consumer, MaterialIds.searedStone,   TinkerIngredients.of(TinkerTags.Items.SEARED_BLOCKS),   4, 1, ItemOutput.fromItem(TinkerSmeltery.searedBrick), folder + "seared_stone/block");
    materialRecipe(consumer, MaterialIds.scorchedStone, TinkerIngredients.of(TinkerSmeltery.scorchedBrick),     1, 1, folder + "scorched_stone/brick");
    materialRecipe(consumer, MaterialIds.scorchedStone, TinkerIngredients.of(TinkerTags.Items.SCORCHED_BLOCKS), 4, 1, ItemOutput.fromItem(TinkerSmeltery.scorchedBrick), folder + "scorched_stone/block");
    materialRecipe(consumer, MaterialIds.venombone,     TinkerIngredients.of(TinkerMaterials.venombone),        1, 1, folder + "venombone");
    metalMaterialRecipe(consumer, MaterialIds.roseGold, folder, "rose_gold", false);
    materialRecipe(consumer, MaterialIds.necroticBone, TinkerIngredients.of(TinkerTags.Items.WITHER_BONES), 1, 1, folder + "necrotic_bone");
    materialRecipe(consumer, MaterialIds.endstone, TinkerIngredients.of(Tags.Items.END_STONES), 1, 1, folder + "endstone");
    // ammo
    materialRecipe(consumer, MaterialIds.turtle,     TinkerIngredients.of(Items.TURTLE_SCUTE),          1, 1, folder + "turtle_scute");
    materialRecipe(consumer, MaterialIds.nautilus,   TinkerIngredients.of(Items.NAUTILUS_SHELL),        4, 1, folder + "nautilus_shell");
    materialRecipe(consumer, MaterialIds.earthslime, TinkerIngredients.of(TinkerWorld.earthGeode),      1, 1, folder + "earthslime");
    materialRecipe(consumer, MaterialIds.skyslime,   TinkerIngredients.of(TinkerWorld.skyGeode),        1, 1, folder + "skyslime");
    materialRecipe(consumer, MaterialIds.blaze,      TinkerIngredients.of(Tags.Items.RODS_BLAZE),       1, 1, folder + "blaze");
    materialRecipe(consumer, MaterialIds.enderPearl, TinkerIngredients.of(Tags.Items.ENDER_PEARLS),     1, 1, folder + "ender_pearl");
    materialRecipe(consumer, MaterialIds.amethyst,   TinkerIngredients.of(Tags.Items.GEMS_AMETHYST),    1, 1, folder + "amethyst");
    materialRecipe(consumer, MaterialIds.prismarine, TinkerIngredients.of(Tags.Items.GEMS_PRISMARINE), 1, 1, folder + "prismarine");
    materialRecipe(consumer, MaterialIds.glass,      TinkerIngredients.of(Tags.Items.GLASS_BLOCKS),     4, 1, folder + "glass");
    materialRecipe(consumer, MaterialIds.glass,      TinkerIngredients.of(Tags.Items.GLASS_PANES),      1, 1, folder + "glass_pane");

    materialRecipe(consumer, MaterialIds.skyslimeVine, TinkerIngredients.of(TinkerWorld.skySlimeVine), 1, 1, folder + "skyslime_vine");
    materialRecipe(consumer, MaterialIds.weepingVine,  TinkerIngredients.of(Items.WEEPING_VINES), 1, 1, folder + "weeping_vine");
    materialRecipe(consumer, MaterialIds.twistingVine, TinkerIngredients.of(Items.TWISTING_VINES), 1, 1, folder + "twisting_vine");
    // slimewood
    materialRecipe(consumer, MaterialIds.greenheart,  TinkerIngredients.of(TinkerWorld.greenheart),  1, 1, folder + "slimewood/greenheart_planks");
    materialRecipe(consumer, MaterialIds.skyroot,     TinkerIngredients.of(TinkerWorld.skyroot),     1, 1, folder + "slimewood/skyroot_planks");
    materialRecipe(consumer, MaterialIds.bloodshroom, TinkerIngredients.of(TinkerWorld.bloodshroom), 1, 1, folder + "slimewood/bloodshroom_planks");
    materialRecipe(consumer, MaterialIds.enderbark,   TinkerIngredients.of(TinkerWorld.enderbark),   1, 1, folder + "slimewood/enderbark_planks");
    materialRecipe(consumer, MaterialIds.greenheart,  TinkerIngredients.of(TinkerWorld.greenheart.getLogItemTag()),  4, 1, ItemOutput.fromItem(TinkerWorld.greenheart),  folder + "slimewood/greenheart_logs");
    materialRecipe(consumer, MaterialIds.skyroot,     TinkerIngredients.of(TinkerWorld.skyroot.getLogItemTag()),     4, 1, ItemOutput.fromItem(TinkerWorld.skyroot),     folder + "slimewood/skyroot_logs");
    materialRecipe(consumer, MaterialIds.bloodshroom, TinkerIngredients.of(TinkerWorld.bloodshroom.getLogItemTag()), 4, 1, ItemOutput.fromItem(TinkerWorld.bloodshroom), folder + "slimewood/bloodshroom_logs");
    materialRecipe(consumer, MaterialIds.enderbark,   TinkerIngredients.of(TinkerWorld.enderbark.getLogItemTag()),   4, 1, ItemOutput.fromItem(TinkerWorld.enderbark),   folder + "slimewood/enderbark_logs");
    // slimeball
    for (SlimeType type : SlimeType.values()) {
      String name = type.getSerializedName();
      materialRecipe(consumer, MaterialVariantId.create(MaterialIds.slimeball, name), TinkerIngredients.of(type.getSlimeballTag()), 1, 1, folder + "slimeball/" + name);
    }
    materialRecipe(consumer, MaterialIds.magma, TinkerIngredients.of(Items.MAGMA_CREAM),1, 1, folder + "magma");
    materialRecipe(consumer, MaterialIds.clay, TinkerIngredients.of(Items.CLAY_BALL),   1, 1, folder + "clay_ball");
    materialRecipe(consumer, MaterialIds.clay, TinkerIngredients.of(Blocks.CLAY),       4, 1, folder + "clay_block");

    // tier 3
    metalMaterialRecipe(consumer, MaterialIds.slimesteel, folder, "slimesteel", false);
    materialRecipe(consumer, MaterialIds.nahuatl, TinkerIngredients.of(TinkerMaterials.nahuatl), 1, 1, folder + "nahuatl");
    ...
    materialRecipe(consumer, MaterialIds.obsidian, TinkerIngredients.of(Items.OBSIDIAN),             4, 1, folder + "obsidian");
    materialRecipe(consumer, MaterialIds.obsidian, TinkerIngredients.of(TinkerCommons.obsidianPane), 1, 1, folder + "obsidian_pane");
    // misc
    materialRecipe(consumer, MaterialIds.ice, TinkerIngredients.of(Blocks.ICE),        1, 9, folder + "ice/unpacked");
    materialRecipe(consumer, MaterialIds.ice, TinkerIngredients.of(Blocks.PACKED_ICE), 1, 1, folder + "ice/packed");
    materialRecipe(consumer, MaterialIds.ice, TinkerIngredients.of(Blocks.BLUE_ICE),   9, 1, folder + "ice/blue");
    materialRecipe(consumer, MaterialIds.ichor, TinkerIngredients.of(TinkerWorld.ichorGeode), 1, 1, folder + "ichor");
    materialRecipe(consumer, MaterialIds.quartz, TinkerIngredients.of(Tags.Items.GEMS_QUARTZ),           1, 1, folder + "quartz/gem");
    materialRecipe(consumer, MaterialIds.quartz, TinkerIngredients.of(TinkerTags.Items.STORAGE_BLOCKS_QUARTZ), 4, 1, folder + "quartz/block");
    materialRecipe(consumer, MaterialIds.glowstone, TinkerIngredients.of(Tags.Items.DUSTS_GLOWSTONE), 1, 4, folder + "glowstone/dust");
    materialRecipe(consumer, MaterialIds.glowstone, TinkerIngredients.of(Blocks.GLOWSTONE), 1, 1, ItemOutput.fromItem(Items.GLOWSTONE_DUST),folder + "glowstone/block");
    materialRecipe(consumer, MaterialIds.magnetite, TinkerIngredients.of(TinkerTags.Items.STEEL_SHARD), 1, 1, folder + "magnetite");
    materialRecipe(consumer, MaterialIds.kobold, TinkerIngredients.of(TinkerTags.Items.COBALT_SHARD), 1, 1, folder + "kobold");
    materialRecipe(consumer, MaterialIds.gunpowder, TinkerIngredients.of(Tags.Items.GUNPOWDERS), 1, 4, folder + "gunpowder");
    materialRecipe(consumer, MaterialIds.redstone, TinkerIngredients.of(Tags.Items.DUSTS_REDSTONE), 1, 4, folder + "redstone/dust");
    materialRecipe(consumer, MaterialIds.redstone, TinkerIngredients.of(Tags.Items.STORAGE_BLOCKS_REDSTONE), 9, 4, ItemOutput.fromItem(Items.REDSTONE, 4), folder + "redstone/block");
    ...
    materialRecipe(consumer, MaterialIds.blazewood, TinkerIngredients.of(TinkerMaterials.blazewood), 1, 1, folder + "blazewood");
    materialRecipe(consumer, MaterialIds.blazingBone, TinkerIngredients.of(TinkerMaterials.blazingBone), 1, 1, folder + "blazing_bone");
    //registerMetalMaterial(consumer, MaterialIds.soulsteel,   "soulsteel",    false);
    // debris has no storage block, just ingots and nuggets
    materialRecipe(consumer, MaterialIds.ancient, TinkerIngredients.of(TinkerTags.Items.INGOTS_NETHERITE_SCRAP), 1, 1, folder + "ancient/ingot");
    materialRecipe(consumer, MaterialIds.ancient, TinkerIngredients.of(TinkerTags.Items.NUGGETS_NETHERITE_SCRAP), 1, 9, folder + "ancient/nugget");
    materialRecipe(consumer, MaterialIds.dragonScale, TinkerIngredients.of(TinkerModifiers.dragonScale), 1, 1, folder + "dragon_scale");
    materialRecipe(consumer, MaterialIds.shulker, TinkerIngredients.of(Items.SHULKER_SHELL), 2, 1, folder + "shulker");
    materialRecipe(consumer, MaterialIds.endRod, TinkerIngredients.of(Items.END_ROD), 1, 1, folder + "end_rod");
    materialRecipe(consumer, MaterialIds.knightly, TinkerIngredients.of(TinkerTags.Items.KNIGHTMETAL_SHARD), 1, 1, folder + "knightly");

    // tier 5
    materialRecipe(consumer, MaterialIds.enderslimeVine, TinkerIngredients.of(TinkerWorld.enderSlimeVine), 1, 1, folder + "enderslime_vine");
    ...
    materialRecipe(withCondition(consumer, tagCondition("treated_wood")),  MaterialIds.treatedWood, TinkerIngredients.of(getItemTag(COMMON, "treated_wood")), 1, 1, folder + "treated_wood");
    ...
    materialRecipe(
      ...
      MaterialIds.necronium, TinkerIngredients.of(TinkerMaterials.necroniumBone), 1, 1, folder + "necronium");
  ...
  private void addMaterialSmeltery(RecipeOutput consumer) {
    ...
    MaterialFluidRecipeBuilder.material(MaterialIds.treatedWood)
      ...
      .setFluid(FluidTinkerIngredients.of(creosote, 125))
      .setTemperature(600)
