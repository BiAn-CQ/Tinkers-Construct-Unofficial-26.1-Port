...
public class TrimMaterialProvider {
  ...
  private static void material(BootstrapContext<TrimMaterial> context, MaterialId material, ItemLike ingredient, int color, float modelIndex) {
    context.register(
      ...
      new TrimMaterial(
        MaterialAssetGroup.create(TConstruct.MOD_ID + "_" + material.getSuffix()),
        Component.translatable(TRIM_FORMAT, Component.translatable(Util.makeDescriptionId("material", material.location())))
