...
public class StationSlotLayoutProvider extends AbstractStationSlotLayoutProvider {
  ...
  protected void addLayouts() {
    // stations
    Ingredient modifiable = TinkerIngredients.of(TinkerTags.Items.MODIFIABLE);
    ...
    definePattern(Patterns.THROWN_AMMO)
      ...
      .addInputPattern(Patterns.ARROW_PART, 33, 53, TinkerIngredients.of(TinkerToolParts.arrowHead, TinkerToolParts.arrowShaft))
      .build();
    ...
    definePattern(Patterns.PLATE_ARMOR)
      ...
      .addInputPattern(Patterns.PLATING,   33, 29, TinkerIngredients.of(TinkerToolParts.plating.values().toArray(new Item[0])))
