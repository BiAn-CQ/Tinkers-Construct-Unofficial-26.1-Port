...
public class ModifierRecipeProvider extends BaseRecipeProvider {
  public ModifierRecipeProvider(net.minecraft.core.HolderLookup.Provider registries, RecipeOutput output) {
  ...
  private void addItemRecipes(RecipeOutput consumer) {
    ...
    ItemCastingRecipeBuilder.tableRecipe(TinkerModifiers.searedReinforcement)
                            .setFluid(FluidTinkerIngredients.of(TinkerFluids.searedStone.ingredient(FluidValues.BRICK), TinkerFluids.scorchedStone.ingredient(FluidValues.BRICK)))
  ...
  private void addModifierRecipes(RecipeOutput consumer) {
    ...
    Ingredient multiuse = DifferenceIngredient.of(TinkerIngredients.of(TinkerTags.Items.MODIFIABLE), TinkerIngredients.of(TinkerTags.Items.SINGLE_USE));
    ...
    // overslime
    Ingredient overslimeTools = TinkerIngredients.of(TinkerTags.Items.DURABILITY);
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.shiny)
                         .addInput(TinkerIngredients.of(Items.ENCHANTED_GOLDEN_APPLE, Items.NETHER_STAR))
                         .setMaxLevel(1)
    ...
    IncrementalModifierRecipeBuilder.modifier(ModifierIds.sharpness)
                                    .setTools(TinkerTags.Items.MELEE)
                                    .setInput(TinkerTags.Items.STORAGE_BLOCKS_QUARTZ, 4, 36)
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.trickQuiver)
                         ...
                         .setTools(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.BOWS), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE)))
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.sliver)
      ...
      .addInput(TinkerWorld.skySlimeVine)
      .setSlots(SlotType.ABILITY, 1)
      .setTools(TinkerIngredients.of(TinkerTags.Items.STAFFS))
    ...
    SwappableModifierRecipeBuilder.modifier(ModifierIds.crystalshot, "random")
                                  .addInput(TinkerIngredients.of(TinkerWorld.earthGeode.getBud(BudSize.CLUSTER), TinkerWorld.skyGeode.getBud(BudSize.CLUSTER)))
                                  .addInput(TinkerIngredients.of(Items.AMETHYST_CLUSTER, Items.NETHER_QUARTZ_ORE))
                                  .addInput(TinkerIngredients.of(TinkerWorld.ichorGeode.getBud(BudSize.CLUSTER), TinkerWorld.enderGeode.getBud(BudSize.CLUSTER)))
                                  .addInput(TinkerMaterials.manyullyn.getIngotTag())
                                  .addInput(TinkerMaterials.manyullyn.getIngotTag())
                                  .setTools(TinkerTags.Items.BOWS)
                                  .setSlots(SlotType.ABILITY, 1)
    ...
    ModifierRecipeBuilder.modifier(TinkerModifiers.sinistral)
                         ...
                         .setMaxLevel(1).checkTraitLevel()
                         .setSlots(SlotType.UPGRADE, 1)
                         .setTools(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.CROSSBOWS), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_LEFT))) // this is the same recipes as dual wielding, but crossbows do not interact on left
    ...
    // throwing
    Ingredient bowLimb = MaterialTinkerIngredients.of(TinkerToolParts.bowLimb.get());
    ModifierRecipeBuilder.modifier(ModifierIds.throwing)
      .setTools(IntersectionIngredient.of(
        TinkerIngredients.of(TinkerTags.Items.DURABILITY),
        TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_CHARGE),
      ...
      .addInput(MaterialTinkerIngredients.of(TinkerToolParts.bowGrip.get()))
      .setSlots(SlotType.ABILITY, 1)
      .setMaxLevel(1).checkTraitLevel()
    ...
    IncrementalModifierRecipeBuilder.modifier(ModifierIds.blockade)
      ...
      .setSlots(SlotType.UPGRADE, 1)
      .setTools(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_CHARGE), TinkerIngredients.of(TinkerTags.Items.DURABILITY)))
      .setMaxLevel(3)
    ...
    ModifierRecipeBuilder.modifier(TinkerModifiers.itemFrame)
                         .setTools(TinkerTags.Items.HELMETS)
                         .addInput(TinkerIngredients.of(Arrays.stream(FrameType.values())
    ...
    // upgrade - leggings
    hasteRecipes(consumer, ModifierIds.speedy, TinkerIngredients.of(TinkerTags.Items.LEGGINGS), 3, upgradeFolder, upgradeSalvage);
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.soulBelt)
                         .addInput(Items.LEATHER)
                         .addInput(TinkerIngredients.of(Items.RECOVERY_COMPASS))
                         .addInput(Items.LEATHER)
                         .setSlots(SlotType.ABILITY, 1)
                         .setMaxLevel(1)
                         .setTools(TinkerTags.Items.LEGGINGS)
    ...
    Ingredient bootsWithDuraibility = IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.BOOTS), TinkerIngredients.of(TinkerTags.Items.DURABILITY));
    ...
    ModifierRecipeBuilder.modifier(TinkerModifiers.melting)
                         .addInput(Items.BLAZE_ROD)
                         .addInput(TinkerIngredients.of(TinkerSmeltery.searedMelter, TinkerSmeltery.smelteryController, TinkerSmeltery.foundryController))
                         .addInput(Items.BLAZE_ROD)
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.splashing)
                         ...
                         .addInput(Tags.Items.INGOTS_COPPER)
                         .setSlots(SlotType.ABILITY, 1)
                         .setTools(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.DURABILITY), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE)))
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.spitting)
      ...
      .setTools(IntersectionIngredient.of(
        TinkerIngredients.of(TinkerTags.Items.DURABILITY),
        TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_CHARGE_MODIFIER)
      ))
    ...
    // block transformers
    Ingredient interactableWithDurability = IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.DURABILITY), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE));
    Ingredient interactableBootsWithDurability = IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.DURABILITY), ingredientFromTags(TinkerTags.Items.INTERACTABLE, TinkerTags.Items.BOOTS));
    SizedIngredient roundPlate = SizedIngredient.of(MaterialTinkerIngredients.of(TinkerToolParts.adzeHead.get()));
    SizedIngredient smallBlade = SizedIngredient.of(MaterialTinkerIngredients.of(TinkerToolParts.smallBlade.get()));
    SizedIngredient toolBinding = SizedIngredient.of(MaterialTinkerIngredients.of(TinkerToolParts.toolBinding.get()));
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.stripping)
                         ...
                         .addInput(SizedIngredient.of(MaterialTinkerIngredients.of(TinkerToolParts.smallAxeHead.get())))
                         .addInput(TinkerMaterials.steel.getIngotTag())
                         .addInput(toolBinding)
                         .setMaxLevel(1).checkTraitLevel()
                         .setSlots(SlotType.ABILITY, 1)
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.brushing)
      .setTools(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.DURABILITY), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_RIGHT)))
    ...
    // slings
    Ingredient blockWhileCharging = IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.DURABILITY), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_CHARGE));
    ...
    ModifierRecipeBuilder.modifier(TinkerModifiers.dualWielding)
                         ...
                         .setMaxLevel(1).checkTraitLevel()
                         .setSlots(SlotType.ABILITY, 1)
                         .setTools(DifferenceIngredient.of(IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.MELEE_WEAPON), TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_RIGHT)), TinkerIngredients.of(TinkerTools.dagger)))
    ...
    ModifierRecipeBuilder.modifier(ModifierIds.blocking)
                         .setTools(DifferenceIngredient.of(
                           IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_CHARGE), TinkerIngredients.of(TinkerTags.Items.DURABILITY)),
    ...
    Ingredient bonusNoSkull = DifferenceIngredient.of(TinkerIngredients.of(TinkerTags.Items.BONUS_SLOTS), TinkerIngredients.of(TinkerTags.Items.SKULLS));
    SizedIngredient standardSkulls = SizedIngredient.of(DifferenceIngredient.of(TinkerIngredients.of(ItemTags.SKULLS), TinkerIngredients.of(Items.DRAGON_HEAD)));
    ...
    Ingredient bonusSkulls = IntersectionIngredient.of(TinkerIngredients.of(TinkerTags.Items.BONUS_SLOTS), TinkerIngredients.of(TinkerTags.Items.SKULLS));
    ModifierRecipeBuilder.modifier(ModifierIds.recapitated)
    ...
    SwappableModifierRecipeBuilder.modifier(ModifierIds.rebalanced, SlotType.DEFENSE.getName())
      .setTools(IntersectionIngredient.of(ingredientFromTags(TinkerTags.Items.ARMOR, TinkerTags.Items.HELD), TinkerIngredients.of(TinkerTags.Items.BONUS_SLOTS)))
    ...
    ModifierRemovalRecipeBuilder.removal()
      .addInput(CompoundIngredient.of(
        ...
        FluidContainerIngredient.fromIngredient(TinkerFluids.venom.ingredient(FluidValues.BOTTLE), TinkerIngredients.of(TinkerFluids.venomBottle)))
      )
      .modifierPredicate(removable)
    ...
    for (boolean dagger : new boolean[]{false, true}) {
      ...
      SizedIngredient tools = dagger ? SizedIngredient.fromItems(2, TinkerTools.dagger) : SizedIngredient.of(DifferenceIngredient.of(TinkerIngredients.of(TinkerTags.Items.MODIFIABLE), TinkerIngredients.of(TinkerTags.Items.UNSALVAGABLE)));
    ...
    ModifierSetWorktableRecipeBuilder.setAdding(hiddenModifiers)
                                     ...
                                     .addInput(FluidContainerIngredient.fromIngredient(TinkerFluids.skySlime.ingredient(FluidValues.BOTTLE), TinkerIngredients.of(TinkerFluids.slimeBottle.get(SlimeType.SKY))))
                                     .save(consumer, location(worktableFolder + "invisible_ink_adding"));
    ModifierSetWorktableRecipeBuilder.setRemoving(hiddenModifiers)
                                     .modifierPredicate(blacklist)
                                     .addInput(FluidContainerIngredient.fromIngredient(FluidTinkerIngredients.of(Fluids.MILK, FluidType.BUCKET_VOLUME), TinkerIngredients.of(Items.MILK_BUCKET)))
                                     .save(consumer, location(worktableFolder + "invisible_ink_removing"));

    // swapping hands
    ToggleInteractionWorktableRecipeBuilder.builder()
      .tools(TinkerIngredients.of(TinkerTags.Items.INTERACTABLE_DUAL))
    ...
    headlight.accept(TinkerIngredients.of(Blocks.LANTERN), "15");
    headlight.accept(TinkerIngredients.of(Blocks.SOUL_LANTERN), "10");
    headlight.accept(TinkerIngredients.of(ItemTags.CANDLES), "5");
  }
  ...
  private static Ingredient ingredientFromTags(TagKey<Item>... tags) {
    ...
    for (int i = 0; i < tags.length; i++) {
      tagIngredients[i] = TinkerIngredients.of(tags[i]);
    }
