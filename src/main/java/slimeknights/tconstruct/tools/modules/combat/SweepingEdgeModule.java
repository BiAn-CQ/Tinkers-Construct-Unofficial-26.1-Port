...
public record SweepingEdgeModule(LevelingValue value) implements ModifierModule, VolatileDataModifierHook, TooltipModifierHook {
  ...
  public void addVolatileData(IToolContext context, ModifierEntry modifier, ToolDataNBT volatileData) {
    volatileData.putFloat(SweepWeaponAttack.SWEEP_PERCENT, volatileData.getFloatOr(SweepWeaponAttack.SWEEP_PERCENT, 0.0f) + value.compute(modifier.getEffectiveLevel()));
  }
