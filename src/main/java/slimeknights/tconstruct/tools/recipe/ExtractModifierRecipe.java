...
public class ExtractModifierRecipe extends ModifierRemovalRecipe {
  ...
  public ExtractModifierRecipe(Identifier id, String name, SizedIngredient toolRequirements, List<SizedIngredient> inputs, List<?> leftovers, IJsonPredicate<ModifierId> modifierPredicate) {
