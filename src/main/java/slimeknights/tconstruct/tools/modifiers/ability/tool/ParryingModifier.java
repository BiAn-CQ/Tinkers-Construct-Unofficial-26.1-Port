...
public class ParryingModifier extends OffhandAttackModifier implements ToolActionModifierHook {
  ...
  public void onFinishUsing(IToolStackView tool, ModifierEntry modifier, LivingEntity entity) {
    if (entity instanceof Player player) {
      player.getCooldowns().addCooldown(net.minecraft.core.registries.BuiltInRegistries.ITEM.getKey(tool.getItem()), (int)(20 / tool.getStats().get(ToolStats.ATTACK_SPEED)));
    }
  }
  ...
  public boolean canPerformAction(IToolStackView tool, ModifierEntry modifier, ItemAbility toolAction) {
    return toolAction == slimeknights.tconstruct.tools.TinkerToolActions.SHIELD_BLOCK;
  }
}
