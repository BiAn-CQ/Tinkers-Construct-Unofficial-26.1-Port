...
public class FirebreathModifier extends NoLevelsModifier implements KeybindInteractModifierHook {
  ...
  protected void registerHooks(Builder hookBuilder) {
    hookBuilder.addModule(FireballModule.builder().damageMultiplier(2.5f).fireball(TinkerIngredients.of(TinkerTags.Items.FIREBALLS)).end().modifier(ModifierIds.fiery).build());
  }
}
