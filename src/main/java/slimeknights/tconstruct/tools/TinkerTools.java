...
import slimeknights.tconstruct.library.json.loot.ItemNameLootEntry;
...
public final class TinkerTools extends TinkerModule {
  ...
  public static final DeferredHolder<CreativeModeTab, ? extends CreativeModeTab> tabTools = CREATIVE_TABS.register(
  ...
  public static final DeferredHolder<MapCodec<? extends LootItemFunction>, MapCodec<? extends LootItemFunction>> lootAddToolData = LOOT_FUNCTIONS.register("add_tool_data", () -> AddToolDataFunction.CODEC);
  public static final DeferredHolder<MapCodec<? extends LootPoolEntryContainer>, MapCodec<? extends LootPoolEntryContainer>> itemNameLootEntry = LOOT_ENTRIES.register("item_name", () -> ItemNameLootEntry.CODEC);

  /*
   * Items
   */
  public static final ItemObject<ModifiableItem> pickaxe = ITEMS.register("pickaxe", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.PICKAXE));
  public static final ItemObject<ModifiableItem> sledgeHammer = ITEMS.register("sledge_hammer", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.SLEDGE_HAMMER));
  public static final ItemObject<ModifiableItem> veinHammer = ITEMS.register("vein_hammer", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.VEIN_HAMMER));

  public static final ItemObject<ModifiableItem> mattock = ITEMS.register("mattock", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.MATTOCK));
  public static final ItemObject<ModifiableItem> pickadze = ITEMS.register("pickadze", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.PICKADZE));
  public static final ItemObject<ModifiableItem> excavator = ITEMS.register("excavator", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.EXCAVATOR));

  public static final ItemObject<ModifiableItem> handAxe = ITEMS.register("hand_axe", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.HAND_AXE));
  public static final ItemObject<ModifiableItem> broadAxe = ITEMS.register("broad_axe", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.BROAD_AXE));

  public static final ItemObject<ModifiableItem> kama = ITEMS.register("kama", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.KAMA));
  public static final ItemObject<ModifiableItem> scythe = ITEMS.register("scythe", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.SCYTHE));

  // Tinkers tools store durability in their own tool data, so do not add the
  // vanilla DAMAGE component.  26.1 rejects DAMAGE together with stacksTo(2).
  public static final ItemObject<ModifiableItem> dagger = ITEMS.register("dagger", () -> new ModifiableSwordItem(itemProperties().stacksTo(2), ToolDefinitions.DAGGER, 2));
  public static final ItemObject<ModifiableItem> sword = ITEMS.register("sword", () -> new ModifiableSwordItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.SWORD));
  public static final ItemObject<ModifiableItem> cleaver = ITEMS.register("cleaver", () -> new ModifiableSwordItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.CLEAVER));

  public static final ItemObject<ModifiableCrossbowItem> crossbow = ITEMS.register("crossbow", () -> new ModifiableCrossbowItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.CROSSBOW));
  public static final ItemObject<ModifiableBowItem> longbow = ITEMS.register("longbow", () -> new ModifiableBowItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.LONGBOW, true));
  public static final ItemObject<ModifiableItem> fishingRod = ITEMS.register("fishing_rod", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.FISHING_ROD));
  public static final ItemObject<ModifiableItem> javelin = ITEMS.register("javelin", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.JAVELIN));
  public static final ItemObject<ModifiableArrowItem> arrow = ITEMS.register("arrow", () -> new ModifiableArrowItem(itemProperties(ITEM_PROPS), ToolDefinitions.ARROW));
  public static final ItemObject<ModifiableShurikenItem> shuriken = ITEMS.register("shuriken", () -> new ModifiableShurikenItem(itemProperties().stacksTo(16), ToolDefinitions.SHURIKEN));
  public static final ItemObject<ModifiableShurikenItem> throwingAxe = ITEMS.register("throwing_axe", () -> new ModifiableShurikenItem(itemProperties().stacksTo(16), ToolDefinitions.THROWING_AXE));

  public static final ItemObject<ModifiableItem> flintAndBrick = ITEMS.register("flint_and_brick", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.FLINT_AND_BRICK));
  public static final ItemObject<ModifiableItem> skyStaff = ITEMS.register("sky_staff", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.SKY_STAFF));
  public static final ItemObject<ModifiableItem> earthStaff = ITEMS.register("earth_staff", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.EARTH_STAFF));
  public static final ItemObject<ModifiableItem> ichorStaff = ITEMS.register("ichor_staff", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.ICHOR_STAFF));
  public static final ItemObject<ModifiableItem> enderStaff = ITEMS.register("ender_staff", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.ENDER_STAFF));

  // ancient
  public static final ItemObject<ModifiableItem> meltingPan = ITEMS.register("melting_pan", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.MELTING_PAN));
  public static final ItemObject<ModifiableCrossbowItem> warPick = ITEMS.register("war_pick", () -> new ModifiableCrossbowItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.WAR_PICK));
  public static final ItemObject<ModifiableItem> battlesign = ITEMS.register("battlesign", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.BATTLESIGN));
  public static final ItemObject<ModifiableItem> swasher = ITEMS.register("swasher", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.SWASHER));
  ...
  static {
    ...
    if (ModList.get().isLoaded("twilightforest")) {
      minotaurAxe = ITEMS.register("minotaur_axe", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ToolDefinitions.MINOTAUR_AXE));
    } else {
  ...
  // armor
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> travelersGear = ITEMS.registerEnum("travelers", ModifiableArmorMaterial.ARMOR_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.TRAVELERS, type, itemProperties(UNSTACKABLE_PROPS)));
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> plateArmor = ITEMS.registerEnum("plate", ModifiableArmorMaterial.ARMOR_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.PLATE, type, itemProperties(UNSTACKABLE_PROPS)));
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> slimesuit = new EnumObject.Builder<ArmorItem.Type,ModifiableArmorItem>(ArmorItem.Type.class)
    .put(ArmorItem.Type.HELMET, ITEMS.register("slime_helmet", () -> new SlimeskullItem(ArmorDefinitions.SLIMESUIT, SlimeskullItem.MODEL_LOCATION, itemProperties(UNSTACKABLE_PROPS))))
    // TODO 1.21: rename to slime chestplate as we no longer need the migration
    .put(ArmorItem.Type.CHESTPLATE, ITEMS.register("slimy_chestplate", () -> new MultilayerArmorItem(ArmorDefinitions.SLIMESUIT, ArmorItem.Type.CHESTPLATE, itemProperties(UNSTACKABLE_PROPS))))
    .putAll(ITEMS.registerEnum("slime", new ArmorItem.Type[] {ArmorItem.Type.LEGGINGS, ArmorItem.Type.BOOTS}, type -> new MultilayerArmorItem(ArmorDefinitions.SLIMESUIT, type, itemProperties(UNSTACKABLE_PROPS))))
    .build();
  public static final ItemObject<MultilayerArmorItem> slimeWings = ITEMS.register("slime_wings", () -> new MultilayerArmorItem(ArmorDefinitions.SLIMESUIT, ArmorItem.Type.CHESTPLATE, itemProperties(UNSTACKABLE_PROPS), ArmorDefinitions.SLIME_WINGS, TinkerTools.slimeWings.getId()));
  ...
  public static final ItemObject<ModifiableItem> plateShield = ITEMS.register("plate_shield", () -> new ModifiableItem(itemProperties(UNSTACKABLE_PROPS), ArmorDefinitions.PLATE_SHIELD));

  // arrows
  public static final ItemObject<ArrowItem> crystalshotItem = ITEMS.register("crystalshot", () -> new CrystalshotItem(itemProperties(ITEM_PROPS)));

  /* Particles */
  public static final DeferredHolder<ParticleType<?>, ? extends SimpleParticleType> hammerAttackParticle = PARTICLE_TYPES.register("hammer_attack", () -> new SimpleParticleType(true));
  public static final DeferredHolder<ParticleType<?>, ? extends SimpleParticleType> axeAttackParticle = PARTICLE_TYPES.register("axe_attack", () -> new SimpleParticleType(true));
  public static final DeferredHolder<ParticleType<?>, ? extends SimpleParticleType> bonkAttackParticle = PARTICLE_TYPES.register("bonk", () -> new SimpleParticleType(true));

  /* Entities */
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<IndestructibleItemEntity>> indestructibleItem = ENTITIES.register("indestructible_item", () ->
    EntityType.Builder.<IndestructibleItemEntity>of(IndestructibleItemEntity::new, MobCategory.MISC)
                      .sized(0.25F, 0.25F)
                      .noLootTable()
                      .fireImmune());
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<CrystalshotEntity>> crystalshotEntity = ENTITIES.register("crystalshot", () ->
    EntityType.Builder.<CrystalshotEntity>of(CrystalshotEntity::new, MobCategory.MISC)
                      .sized(0.5F, 0.5F)
                      .noLootTable()
                      .clientTrackingRange(4)
                      .updateInterval(20));
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<CombatFishingHook>> fishingHook = ENTITIES.register("fishing_bobber", () -> EntityType.Builder.<CombatFishingHook>of(CombatFishingHook::new, MobCategory.MISC).noSave().noSummon().noLootTable().sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(5));
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<ModifiableArrow>> materialArrow = ENTITIES.register("arrow", () -> EntityType.Builder.<ModifiableArrow>of(ModifiableArrow::new, MobCategory.MISC).noLootTable().sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<ThrownShuriken>> thrownShuriken = ENTITIES.register("thrown_shuriken", () -> EntityType.Builder.<ThrownShuriken>of(ThrownShuriken::new, MobCategory.MISC).noLootTable().sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10));
  public static final DeferredHolder<EntityType<?>, ? extends EntityType<ThrownTool>> thrownTool = ENTITIES.register("thrown_tool", () -> EntityType.Builder.<ThrownTool>of(ThrownTool::new, MobCategory.MISC).noLootTable().sized(0.5f, 0.5f).clientTrackingRange(4).updateInterval(20));
  static {
  ...
  /* Containers */
  public static final DeferredHolder<MenuType<?>, ? extends MenuType<ToolContainerMenu>> toolContainer = MENUS.register("tool_container", ToolContainerMenu::forClient);
  ...
  void registerCapabilities(RegisterCapabilitiesEvent event) {
    for (Item item : BuiltInRegistries.ITEM) {
      if (item instanceof IModifiable) {
        event.registerItem(Capabilities.Fluid.ITEM, (stack, context) -> ToolCapabilityProvider.get(stack, Capabilities.Fluid.ITEM, context), item);
        event.registerItem(Capabilities.Item.ITEM, (stack, context) -> ToolCapabilityProvider.get(stack, Capabilities.Item.ITEM, context), item);
        event.registerItem(Capabilities.Energy.ITEM, (stack, context) -> ToolCapabilityProvider.get(stack, Capabilities.Energy.ITEM, context), item);
        event.registerItem(BlockItemProviderCapability.CAPABILITY, (stack, context) -> ToolCapabilityProvider.get(stack, BlockItemProviderCapability.CAPABILITY, context), item);
      }
    }
  }
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      ...
      event.register(net.neoforged.neoforge.registries.NeoForgeRegistries.Keys.INGREDIENT_TYPES, helper ->
        helper.register(ToolHookIngredient.ID, ToolHookIngredient.TYPE));
    }
  }
