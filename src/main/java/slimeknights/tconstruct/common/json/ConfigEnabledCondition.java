...
public class ConfigEnabledCondition implements LootItemCondition, ICondition {
  ...
  /** Evaluates the same config-backed condition during datapack and recipe reloads. */
  @Override
