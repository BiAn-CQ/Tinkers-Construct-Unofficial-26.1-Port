...
public class TinkerTags {
  ...
  public static class Blocks {
    ...
    public static final TagKey<Block> GLASS_BLOCKS_SILICA = common("glass_blocks/silica");
  ...
  public static class Items {
    /** Armor trim smithing templates. Vanilla removed its equivalent tag in 26.1. */
    public static final TagKey<Item> TRIM_TEMPLATES = local("trim_templates");

    private static void init() {}
    public static final TagKey<Item> WORKBENCHES = common("workbenches");
    public static final TagKey<Item> TABLES = local("tables");
    public static final TagKey<Item> GLASS_BLOCKS_SILICA = common("glass_blocks/silica");
    ...
    /** Quartz blocks usable as the compact quartz input in material and modifier recipes. */
    public static final TagKey<Item> STORAGE_BLOCKS_QUARTZ = common("storage_blocks/quartz");
  ...
  public static class Biomes {
    ...
    /** Overworld biomes where sky geodes may generate. */
    public static final TagKey<Biome> SKY_GEODE = local("features/sky_geode");
    /** Outer End biomes where ender geodes may generate. */
    public static final TagKey<Biome> ENDER_GEODE = local("features/ender_geode");
    /** Overworld biomes where terracubes may spawn. */
    public static final TagKey<Biome> TERRACUBE_SPAWNS = local("spawns/terracube");
  ...
  public static class Modifiers {
    ...
    /** Modifiers in this tag allow melting recipes and should be listed as item and entity melting catalysts */
    public static final TagKey<Modifier> MELTING = local("jei/melting");
    /** Modifiers in this tag allow severing and should be listed as a severing catalyst */
