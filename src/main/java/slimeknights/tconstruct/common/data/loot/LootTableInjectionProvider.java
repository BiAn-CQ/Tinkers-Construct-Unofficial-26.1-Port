...
public class LootTableInjectionProvider extends AbstractLootTableInjectionProvider {
  ...
  protected void addTables() {
    ...
    for (ArmorSlotType slot : slimeknights.tconstruct.library.tools.definition.ModifiableArmorMaterial.ARMOR_TYPES) {
    ...
    LootPoolEntryContainer minotaurAxe = ItemNameLootEntry.item(TinkerTools.minotaurAxe.getId())
