 ...
 */
public class TinkerStationRepairRecipe implements ITinkerStationRecipe, IMultiRecipe<AbstractCraftingTinkeringRecipe> {
  ...
  public TinkerStationRepairRecipe() { this(TConstruct.getResource("tables/tinker_station_repair")); }

  /** Compatibility constructor retained for specialized repair recipes. */
  public TinkerStationRepairRecipe(Identifier id) { this.id = id; }
  ...
  @Override
  public List<AbstractCraftingTinkeringRecipe> getRecipes(HolderLookup.Provider access) {
    if (displayRecipes == null) {
      ...
      List<AbstractCraftingTinkeringRecipe> recipes = new ArrayList<>();
  ...
  @Internal
  public static void setCraftingId(List<AbstractCraftingTinkeringRecipe> recipes, Identifier id) {
  ...
  @Getter
  private static abstract class DisplayRecipe extends AbstractCraftingTinkeringRecipe {
    ...
    private DisplayRecipe(Identifier id, List<ItemStack> toolWithoutModifier) {
      this.id = id;
      this.recipeId = id;
  ...
  private static class FixedDisplayRecipe extends DisplayRecipe {
    ...
    public FixedDisplayRecipe(Identifier id, Item tool, List<ItemStack> inputs, List<ItemStack> toolWithoutModifier) {
  ...
  private static class DynamicDisplayRecipe extends DisplayRecipe {
    ...
    public DynamicDisplayRecipe(Identifier id, Set<Item> tools, List<ItemStack> toolWithoutModifier) {
      super(id, toolWithoutModifier);
      this.tools = tools;
    }
