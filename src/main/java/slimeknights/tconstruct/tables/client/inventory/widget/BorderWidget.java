...
public class BorderWidget extends Widget {
  ...
  public void updateParent(ModuleScreen<?,?> gui) {
    gui.offsetLayoutPosition(-this.borderLeft.w, -this.borderTop.h);

    gui.setLayoutWidth(gui.getLayoutWidth() + this.borderLeft.w + this.borderRight.w);
    gui.setLayoutHeight(gui.getLayoutHeight() + this.borderTop.h + this.borderBottom.h);
  }
