...
public class ModifierWorktableCategory implements slimeknights.tconstruct.plugin.jei.TinkersRecipeCategory<IModifierWorktableRecipe> {
  ...
  @Override
  public void getTooltip(mezz.jei.api.gui.builder.ITooltipBuilder tooltip, IModifierWorktableRecipe recipe, IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
