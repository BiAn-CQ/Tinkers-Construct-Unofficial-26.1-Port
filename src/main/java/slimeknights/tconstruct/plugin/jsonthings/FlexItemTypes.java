  ...
  public static void init() {
    ...
    register("tool", data -> {
      ...
      return (IToolItemFactory<ModifiableItem>)(props, builder) -> {
        // Tinkers tools keep durability in their own tool data.  In 26.1,
        // Item.Properties#durability also adds the vanilla DAMAGE component,
        // which cannot coexist with a stack size greater than one.
