...
public class GuiFuelModule implements IScreenWithFluidTank, ClickableTankModule {
  ...
  public void draw(GuiGraphicsExtractor graphics) {
    ...
    if (fuel > 0 && fuelQuality > 0) {
      fire.drawScaledYUp(graphics, fireX + GuiUtil.getGuiLeft(screen), fireY + GuiUtil.getGuiTop(screen), 14 * fuel / fuelQuality);
    }
  ...
  public void addTooltip(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hasTank) {
    int checkX = mouseX - GuiUtil.getGuiLeft(screen);
