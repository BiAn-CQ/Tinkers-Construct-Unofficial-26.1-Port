...
import slimeknights.tconstruct.library.data.recipe.ConditionalRecipeBuilder;
...
public class SmelteryRecipeProvider extends BaseRecipeProvider implements ISmelteryRecipeHelper, ICommonRecipeHelper {
  public SmelteryRecipeProvider(net.minecraft.core.HolderLookup.Provider registries, RecipeOutput output) {
  ...
  private void addCraftingRecipes(RecipeOutput consumer) {
    shaped(RecipeCategory.MISC, TinkerSmeltery.copperCan, 3)
                       .define('c', ingredient(Tags.Items.INGOTS_COPPER))
                       .pattern("c c")
                       .pattern(" c ")
    ...
    // sand casts
    shapeless(RecipeCategory.MISC, TinkerSmeltery.blankSandCast, 4)
                          .requires(ingredient(Tags.Items.SANDS_COLORLESS))
                          .unlockedBy("has_casting", has(TinkerSmeltery.searedTable))
                          .save(consumer, recipeKey(location("smeltery/sand_cast")));
    shapeless(RecipeCategory.MISC, TinkerSmeltery.blankRedSandCast, 4)
                          .requires(ingredient(Tags.Items.SANDS_RED))
                          .unlockedBy("has_casting", has(TinkerSmeltery.searedTable))
    ...
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.endFluidCannon)
      .define('R', ingredient(Tags.Items.DUSTS_REDSTONE))
      .define('T', Items.SHULKER_SHELL)
      .define('C', ingredient(TinkerMaterials.knightmetal.getIngotTag()))
      .pattern(" R ")
      .pattern("CTC")
      .pattern("CCC")
  ...
  private void addSmelteryRecipes(RecipeOutput consumer) {
    ...
    // grout crafting
    shapeless(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.grout, 2)
                          .requires(Items.CLAY_BALL)
                          .requires(ingredient(ItemTags.SAND))
    ...
    shapeless(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.grout, 8)
                          .requires(Blocks.CLAY)
                          .requires(ingredient(ItemTags.SAND)).requires(ingredient(ItemTags.SAND)).requires(ingredient(ItemTags.SAND)).requires(ingredient(ItemTags.SAND))
    ...
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.grout), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.searedBrick, 0.3f, 200)
                        .unlockedBy("has_item", has(TinkerSmeltery.grout))
                        .save(consumer, recipeKey(prefix(TinkerSmeltery.searedBrick, folder)));
    ConditionalRecipeBuilder.RecipeGenerator fastGrout = (c, id) ->
      SimpleCookingRecipeBuilder.blasting(TinkerIngredients.of(TinkerSmeltery.grout), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.searedBrick, 0.3f, 100)
                          .unlockedBy("has_item", has(TinkerSmeltery.grout)).save(c, recipeKey(id));
    ConditionalRecipeBuilder.builder()
                     .addCondition(new ModLoadedCondition("ceramics"))
                     // Temporary: RecipeOutput cannot emit the external ceramics:kiln serializer without Ceramics on the datagen classpath.
                     .addRecipe(fastGrout)
                     .addCondition(AlwaysCondition.INSTANCE)
                     .addRecipe(fastGrout)
                     .generateAdvancement()
    ...
    // block from bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedBricks)
    ...
    // ladder from bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedLadder, 4)
                       .define('b', TinkerSmeltery.searedBrick)
                       .define('B', ingredient(TinkerTags.Items.SEARED_BRICKS))
                       .pattern("b b")
                       .pattern("b b")
                       .pattern("BBB")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
    ...
    // cobble -> stone
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.searedCobble.get()), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.searedStone, 0.1f, 200)
    ...
    // stone -> paver
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.searedStone.get()), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.searedPaver, 0.1f, 200)
    ...
    // stone -> bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedBricks, 4)
    ...
    // bricks -> cracked
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.searedBricks), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.searedCrackedBricks, 0.1f, 200)
    ...
    // brick slabs -> fancy
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedFancyBricks)
    ...
    // seared glass
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedGlass)
                       .define('b', TinkerSmeltery.searedBrick)
                       .define('G', ingredient(Tags.Items.GLASS_BLOCKS_COLORLESS))
                       .pattern(" b ")
                       .pattern("bGb")
                       .pattern(" b ")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
                       .save(consumer, recipeKey(prefix(TinkerSmeltery.searedGlass, folder)));
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedLamp)
      .define('b', TinkerSmeltery.searedBrick)
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedGlassPane, 16)
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedSoulGlass)
                       .define('b', TinkerSmeltery.searedBrick)
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedSoulGlassPane, 16)
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedTintedGlass)
                       .define('b', TinkerSmeltery.searedBrick)
                       .define('G', ingredient(Tags.Items.GLASS_BLOCKS_TINTED))
                       .pattern(" b ")
                       .pattern("bGb")
                       .pattern(" b ")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
    ...
    // tanks
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedTank.get(TankType.FUEL_TANK))
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('B', ingredient(Tags.Items.GLASS_BLOCKS))
                       .pattern("###")
                       .pattern("#B#")
                       .pattern("###")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
                       .save(consumer, recipeKey(location(folder + "fuel_tank")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedTank.get(TankType.FUEL_GAUGE))
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('B', ingredient(Tags.Items.GLASS_BLOCKS))
                       .pattern("#B#")
                       .pattern("BBB")
    ...
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedTank.get(TankType.INGOT_TANK))
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('B', ingredient(Tags.Items.GLASS_BLOCKS))
                       .pattern("#B#")
                       .pattern("#B#")
    ...
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedTank.get(TankType.INGOT_GAUGE))
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('B', ingredient(Tags.Items.GLASS_BLOCKS))
                       .pattern("B#B")
                       .pattern("#B#")
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedLantern.get(), 3)
                       .define('C', ingredient(Tags.Items.INGOTS_IRON))
                       .define('B', TinkerSmeltery.searedBrick)
    ...
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedCastingTank.get())
                       .define('B', TinkerSmeltery.searedBrick)
                       .define('G', ingredient(Tags.Items.GLASS_BLOCKS))
                       .define('C', ingredient(Tags.Items.INGOTS_COPPER))
                       .pattern("BGB")
                       .pattern("CGC")
                       .pattern("BGB")
    ...
    // fluid transfer
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedFaucet.get(), 3)
                       .define('#', TinkerSmeltery.searedBrick)
                       .pattern("# #")
                       .pattern(" # ")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
                       .save(consumer, recipeKey(location(folder + "faucet")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedChannel.get(), 5)
                       .define('#', TinkerSmeltery.searedBrick)
                       .pattern("# #")
                       .pattern("###")
                       .unlockedBy("has_item", has(TinkerSmeltery.searedBrick))
    ...
    // casting
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedBasin.get())
                       .define('#', TinkerSmeltery.searedBrick)
                       .pattern("# #")
                       .pattern("# #")
                       .pattern("###")
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedTable.get())
                       .define('#', TinkerSmeltery.searedBrick)
                       .pattern("###")
                       .pattern("# #")
                       .pattern("# #")
    ...
    // peripherals
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.copperGauge, 4)
    ...
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedDrain)
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('C', ingredient(Tags.Items.INGOTS_COPPER))
                       .pattern("# #")
                       .pattern("C C")
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedDrain)
        .define('#', ingredient(TinkerTags.Items.SMELTERY_BRICKS))
        .define('C', ingredient(Tags.Items.INGOTS_COPPER))
        .pattern("C#C")
        .unlockedBy("has_item", has(TinkerTags.Items.SMELTERY_BRICKS)))
      .setSource(TinkerIngredients.of(TinkerTags.Items.SMELTERY_BRICKS))
      .build(consumer, recipeKey(location(folder + "drain_retextured")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedChute)
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('C', ingredient(Tags.Items.INGOTS_COPPER))
                       .pattern("#C#")
                       .pattern("   ")
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedChute)
        ...
        .unlockedBy("has_item", has(TinkerTags.Items.SMELTERY_BRICKS)))
      .setSource(TinkerIngredients.of(TinkerTags.Items.SMELTERY_BRICKS))
      .build(consumer, recipeKey(location(folder + "chute_retextured")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedDuct)
                       .define('#', TinkerSmeltery.searedBrick)
                       .define('C', ingredient(Tags.Items.INGOTS_GOLD))
                       .pattern("# #")
                       .pattern("C C")
                       .pattern("# #")
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedDuct)
        ...
        .unlockedBy("has_item", has(TinkerTags.Items.SMELTERY_BRICKS)))
      .setSource(TinkerIngredients.of(TinkerTags.Items.SMELTERY_BRICKS))
      .build(consumer, recipeKey(location(folder + "duct_retextured")));
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedMelter)
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.searedHeater)
                       .define('B', TinkerSmeltery.searedBrick)
                       .pattern("BBB")
                       .pattern("B B")
                       .pattern("BBB")
    ...
    // fluid cannon
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.searedFluidCannon)
      .define('R', ingredient(Tags.Items.DUSTS_REDSTONE))
    ...
    // cobble
    searedCasting(consumer, TinkerSmeltery.searedCobble, CompoundIngredient.of(TinkerIngredients.of(Tags.Items.COBBLESTONES), TinkerIngredients.of(Blocks.GRAVEL)), castingFolder + "cobble/block");
    searedSlabCasting(consumer, TinkerSmeltery.searedCobble.getSlab(), TinkerIngredients.of(Blocks.COBBLESTONE_SLAB), castingFolder + "cobble/slab");
    searedCasting(consumer, TinkerSmeltery.searedCobble.getStairs(), TinkerIngredients.of(Blocks.COBBLESTONE_STAIRS), castingFolder + "cobble/stairs");
    searedCasting(consumer, TinkerSmeltery.searedCobble.getWall(), TinkerIngredients.of(Blocks.COBBLESTONE_WALL), castingFolder + "cobble/wall");
    // stone
    searedCasting(consumer, TinkerSmeltery.searedStone, TinkerIngredients.of(Tags.Items.STONES), castingFolder + "stone/block_from_clay");
    searedSlabCasting(consumer, TinkerSmeltery.searedStone.getSlab(), TinkerIngredients.of(Blocks.STONE_SLAB), castingFolder + "stone/slab");
    searedCasting(consumer, TinkerSmeltery.searedStone.getStairs(), TinkerIngredients.of(Blocks.STONE_STAIRS), castingFolder + "stone/stairs");
    // stone bricks
    searedCasting(consumer, TinkerSmeltery.searedBricks, TinkerIngredients.of(Blocks.STONE_BRICKS), castingFolder + "bricks/block");
    searedSlabCasting(consumer, TinkerSmeltery.searedBricks.getSlab(), TinkerIngredients.of(Blocks.STONE_BRICK_SLAB), castingFolder + "bricks/slab");
    searedCasting(consumer, TinkerSmeltery.searedBricks.getStairs(), TinkerIngredients.of(Blocks.STONE_BRICK_STAIRS), castingFolder + "bricks/stairs");
    searedCasting(consumer, TinkerSmeltery.searedBricks.getWall(), TinkerIngredients.of(Blocks.STONE_BRICK_WALL), castingFolder + "bricks/wall");
    // other seared
    searedCasting(consumer, TinkerSmeltery.searedCrackedBricks, TinkerIngredients.of(Blocks.CRACKED_STONE_BRICKS), castingFolder + "cracked");
    searedCasting(consumer, TinkerSmeltery.searedFancyBricks, TinkerIngredients.of(Blocks.CHISELED_STONE_BRICKS), castingFolder + "chiseled");
    searedCasting(consumer, TinkerSmeltery.searedPaver, TinkerIngredients.of(Blocks.SMOOTH_STONE), castingFolder + "paver");

    // seared blocks
    String meltingFolder = "smeltery/melting/seared/";

    // double efficiency when using smeltery for grout
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.grout), TinkerFluids.searedStone, FluidValues.BRICK * 2, 1.5f)
                        .save(consumer, location(meltingFolder + "grout"));
    // seared stone
    // stairs are here since the cheapest stair recipe is stone cutter, 1 to 1
    MeltingRecipeBuilder.melting(CompoundIngredient.of(TinkerIngredients.of(TinkerTags.Items.SEARED_BLOCKS),
                                                       TinkerIngredients.of(TinkerSmeltery.searedLadder, TinkerSmeltery.searedLamp,
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedCobble.getSlab(), TinkerSmeltery.searedStone.getSlab(), TinkerSmeltery.searedBricks.getSlab(), TinkerSmeltery.searedPaver.getSlab()),
																 TinkerFluids.searedStone, FluidValues.BRICK_BLOCK / 2, 1.5f)
                        .save(consumer, location(meltingFolder + "slab"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedBrick), TinkerFluids.searedStone, FluidValues.BRICK, 1.0f)
                        .save(consumer, location(meltingFolder + "brick"));

    // melt down smeltery components
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedFaucet, TinkerSmeltery.searedChannel), TinkerFluids.searedStone, FluidValues.BRICK, 1.5f)
                        .save(consumer, location(meltingFolder + "faucet"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedBasin, TinkerSmeltery.searedTable), TinkerFluids.searedStone, FluidValues.BRICK * 7, 2.5f)
    ...
    // glass
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedGlass), TinkerFluids.searedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.moltenGlass.result( FluidValues.GLASS_BLOCK))
                        .save(consumer, location(meltingFolder + "glass"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedSoulGlass), TinkerFluids.searedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.liquidSoul.result( FluidValues.GLASS_BLOCK))
                        .save(consumer, location(meltingFolder + "glass_soul"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedTintedGlass), TinkerFluids.searedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_BLOCK))
                        .addByproduct(TinkerFluids.moltenAmethyst.result(FluidValues.GEM * 2))
                        .save(consumer, location(meltingFolder + "glass_tinted"));
    // panes
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedGlassPane), TinkerFluids.searedStone, FluidValues.BRICK, 1.0f)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_PANE))
                        .save(consumer, location(meltingFolder + "pane"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedSoulGlassPane), TinkerFluids.searedStone, FluidValues.BRICK, 1.0f)
                        .addByproduct(TinkerFluids.liquidSoul.result(FluidValues.GLASS_PANE))
                        .save(consumer, location(meltingFolder + "pane_soul"));
    // controllers
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedMelter), TinkerFluids.searedStone, FluidValues.BRICK * 9, 3.5f)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_PANE * 5))
                        .save(consumer, location(meltingFolder + "melter"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedHeater), TinkerFluids.searedStone, FluidValues.BRICK * 8, 3f)
                        .save(consumer, location(meltingFolder + "heater"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedFluidCannon), TinkerFluids.moltenCopper, FluidValues.INGOT * 5, 2.5f)
                        .addByproduct(TinkerFluids.searedStone.result(FluidValues.BRICK * 4))
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_PANE * 5))
                        .save(consumer, location(meltingFolder + "fluid_cannon"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.smelteryController), TinkerFluids.moltenCopper, FluidValues.INGOT * 4, 3.5f)
                        .addByproduct(TinkerFluids.searedStone.result(FluidValues.BRICK * 4))
                        .save(consumer, location("smeltery/melting/metal/copper/smeltery_controller"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.copperGauge), TinkerFluids.moltenCopper, FluidValues.INGOT, 1f)
      .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_PANE / 5))
      .save(consumer, location("smeltery/melting/metal/copper/gauge"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedDrain, TinkerSmeltery.searedChute), TinkerFluids.moltenCopper, FluidValues.INGOT * 2, 2.5f)
                        .addByproduct(TinkerFluids.searedStone.result(FluidValues.BRICK * 4))
                        .save(consumer, location("smeltery/melting/metal/copper/smeltery_io"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.searedDuct), TinkerFluids.moltenGold, FluidValues.INGOT * 2, 2.5f)
                        .addByproduct(TinkerFluids.searedStone.result(FluidValues.BRICK * 4))
  ...
  private void addFoundryRecipes(RecipeOutput consumer) {
    ...
    // grout crafting
    Ingredient soulSand = TinkerIngredients.of(Blocks.SOUL_SAND, Blocks.SOUL_SOIL);
    shapeless(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.netherGrout, 2)
                          .requires(Items.MAGMA_CREAM)
                          .requires(soulSand)
                          .requires(Blocks.GRAVEL)
                          .unlockedBy("has_item", has(Items.MAGMA_CREAM))
                          .save(consumer, recipeKey(prefix(TinkerSmeltery.netherGrout, folder)));
    shapeless(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.netherGrout, 8)
    ...
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.netherGrout), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.scorchedBrick, 0.3f, 200)
                              .unlockedBy("has_item", has(TinkerSmeltery.netherGrout))
                              .save(consumer, recipeKey(prefix(TinkerSmeltery.scorchedBrick, folder)));
    ConditionalRecipeBuilder.RecipeGenerator fastGrout = (c, id) ->
      SimpleCookingRecipeBuilder.blasting(TinkerIngredients.of(TinkerSmeltery.netherGrout), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.scorchedBrick, 0.3f, 100)
                                .unlockedBy("has_item", has(TinkerSmeltery.netherGrout)).save(c, recipeKey(id));
    ConditionalRecipeBuilder.builder()
                     .addCondition(new ModLoadedCondition("ceramics"))
                     // Temporary: RecipeOutput cannot emit the external ceramics:kiln serializer without Ceramics on the datagen classpath.
                     .addRecipe(fastGrout)
    ...
    // block from bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedBricks)
    ...
    // ladder from bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedLadder, 4)
                       .define('b', TinkerSmeltery.scorchedBrick)
                       .define('B', ingredient(TinkerTags.Items.SCORCHED_BLOCKS))
                       .pattern("b b")
                       .pattern("b b")
                       .pattern("BBB")
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
    ...
    // stone -> polished
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.polishedScorchedStone, 4)
    ...
    // polished -> bricks
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedBricks, 4)
    ...
    // stone -> road
    SimpleCookingRecipeBuilder.smelting(TinkerIngredients.of(TinkerSmeltery.scorchedStone), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, TinkerSmeltery.scorchedRoad, 0.1f, 200)
                        .unlockedBy("has_item", has(TinkerSmeltery.scorchedStone))
                        .save(consumer, recipeKey(wrap(TinkerSmeltery.scorchedRoad, folder, "_smelting")));
    // brick slabs -> chiseled
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.chiseledScorchedBricks)
    ...
    // scorched glass
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedGlass)
                       .define('b', TinkerSmeltery.scorchedBrick)
                       .define('G', ingredient(Tags.Items.GEMS_QUARTZ))
                       .pattern(" b ")
                       .pattern("bGb")
                       .pattern(" b ")
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(prefix(TinkerSmeltery.scorchedGlass, folder)));
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedLamp)
      .define('b', TinkerSmeltery.scorchedBrick)
      .define('G', Blocks.GLOWSTONE)
      .pattern(" b ")
      .pattern("bGb")
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedSoulGlass)
                       .define('b', TinkerSmeltery.scorchedBrick)
                       .define('G', TinkerCommons.soulGlass)
                       .pattern(" b ")
                       .pattern("bGb")
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedTintedGlass)
                       .define('b', TinkerSmeltery.scorchedBrick)
                       .define('G', ingredient(Tags.Items.GLASS_BLOCKS_TINTED))
                       .pattern(" b ")
                       .pattern("bGb")
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedGlassPane, 16)
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedSoulGlassPane, 16)
    ...
    shaped(RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedBricks.getFence(), 6)
    ...
    // tanks
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedTank.get(TankType.FUEL_TANK))
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('B', ingredient(Tags.Items.GEMS_QUARTZ))
                       .pattern("###")
                       .pattern("#B#")
                       .pattern("###")
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(location(folder + "fuel_tank")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedTank.get(TankType.FUEL_GAUGE))
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('B', ingredient(Tags.Items.GEMS_QUARTZ))
                       .pattern("#B#")
                       .pattern("BBB")
                       ...
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(location(folder + "fuel_gauge")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedTank.get(TankType.INGOT_TANK))
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('B', ingredient(Tags.Items.GEMS_QUARTZ))
                       .pattern("#B#")
                       .pattern("#B#")
                       ...
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(location(folder + "ingot_tank")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedTank.get(TankType.INGOT_GAUGE))
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('B', ingredient(Tags.Items.GEMS_QUARTZ))
                       .pattern("B#B")
                       .pattern("#B#")
                       ...
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(location(folder + "ingot_gauge")));
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedLantern.get(), 3)
                       .define('C', ingredient(Tags.Items.INGOTS_IRON))
                       .define('B', TinkerSmeltery.scorchedBrick)
    ...
    // fluid transfer
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedFaucet.get(), 3)
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .pattern("# #")
                       .pattern(" # ")
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
                       .save(consumer, recipeKey(location(folder + "faucet")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedChannel.get(), 5)
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .pattern("# #")
                       .pattern("###")
                       .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
    ...
    // casting
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedBasin.get())
      .define('#', TinkerSmeltery.scorchedBrick)
      ...
      .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
      .save(consumer, recipeKey(location(folder + "basin")));
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedTable.get())
      .define('#', TinkerSmeltery.scorchedBrick)
      ...
      .unlockedBy("has_item", has(TinkerSmeltery.scorchedBrick))
      .save(consumer, recipeKey(location(folder + "table")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedProxyTank.get())
      .define('#', TinkerSmeltery.scorchedBrick)
      .define('G', ingredient(Tags.Items.GEMS_QUARTZ))
    ...
    // peripherals
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.obsidianGauge, 4)
      .define('G', ingredient(Tags.Items.GLASS_PANES_COLORLESS))
      .define('C', TinkerCommons.obsidianPane)
      .pattern(" C ")
      .pattern("CGC")
      ...
      .unlockedBy("has_item", has(TinkerCommons.obsidianPane))
      .save(consumer, recipeKey(location(folder + "gauge")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedDrain)
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('C', TinkerCommons.obsidianPane)
                       .pattern("# #")
                       .pattern("C C")
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedDrain)
        .define('#', ingredient(TinkerTags.Items.FOUNDRY_BRICKS))
        .define('C', TinkerCommons.obsidianPane)
        .pattern("C#C")
        .unlockedBy("has_item", has(TinkerTags.Items.FOUNDRY_BRICKS)))
      .setSource(TinkerIngredients.of(TinkerTags.Items.FOUNDRY_BRICKS))
      .build(consumer, recipeKey(location(folder + "drain_retextured")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedChute)
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('C', TinkerCommons.obsidianPane)
                       .pattern("#C#")
                       .pattern("   ")
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      ...
      .setSource(TinkerIngredients.of(TinkerTags.Items.FOUNDRY_BRICKS))
      .build(consumer, recipeKey(location(folder + "chute_retextured")));
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedDuct)
                       .define('#', TinkerSmeltery.scorchedBrick)
                       .define('C', ingredient(Tags.Items.INGOTS_GOLD))
                       .pattern("# #")
                       .pattern("C C")
    ...
    shaped(RecipeCategory.DECORATIONS, TinkerSmeltery.scorchedAlloyer)
                       .define('G', similarTanks)
                       .define('B', TinkerSmeltery.scorchedBrick)
                       .pattern("BGB")
                       .pattern("BBB")
    ...
    // fluid cannon
    shaped(RecipeCategory.REDSTONE, TinkerSmeltery.scorchedFluidCannon)
      .define('R', ingredient(Tags.Items.DUSTS_REDSTONE))
      .define('T', similarTanks)
      .define('C', ingredient(TinkerMaterials.cobalt.getIngotTag()))
      .pattern(" R ")
      .pattern("CTC")
      .pattern("CCC")
    ...
    ItemCastingRecipeBuilder.tableRecipe(TinkerSmeltery.scorchedBrick)
                            ...
                            .save(consumer, location(castingFolder + "brick_composite"));
    scorchedCasting(consumer, TinkerSmeltery.scorchedStone, TinkerIngredients.of(Blocks.BASALT , Blocks.GRAVEL), castingFolder + "stone_from_magma");
    scorchedCasting(consumer, TinkerSmeltery.polishedScorchedStone, TinkerIngredients.of(Blocks.POLISHED_BASALT), castingFolder + "polished_from_magma");
    // foundry controller
    ...
    // double efficiency when using smeltery for grout
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.netherGrout), TinkerFluids.scorchedStone, FluidValues.BRICK * 2, 1.5f)
                        .save(consumer, location(meltingFolder + "grout"));

    // scorched stone
    // stairs are here since the cheapest stair recipe is stone cutter, 1 to 1
    MeltingRecipeBuilder.melting(CompoundIngredient.of(TinkerIngredients.of(TinkerTags.Items.SCORCHED_BLOCKS),
                                                       TinkerIngredients.of(TinkerSmeltery.scorchedLadder, TinkerSmeltery.scorchedLamp,
                        ...
                        .save(consumer, location(meltingFolder + "block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedBricks.getSlab(), TinkerSmeltery.scorchedBricks.getSlab(), TinkerSmeltery.scorchedRoad.getSlab()),
																 TinkerFluids.scorchedStone, FluidValues.BRICK_BLOCK / 2, 1.5f)
                        .save(consumer, location(meltingFolder + "slab"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedBrick), TinkerFluids.scorchedStone, FluidValues.BRICK, 1.0f)
                        .save(consumer, location(meltingFolder + "brick"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedBricks.getFence()), TinkerFluids.scorchedStone, FluidValues.BRICK * 3, 1.0f)
                        .save(consumer, location(meltingFolder + "fence"));

    // melt down foundry components
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedFaucet, TinkerSmeltery.scorchedChannel), TinkerFluids.scorchedStone, FluidValues.BRICK, 1.5f)
                        .save(consumer, location(meltingFolder + "faucet"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedBasin), TinkerFluids.scorchedStone, FluidValues.BRICK * 7, 2.5f)
      .addByproduct(TinkerFluids.moltenGold.result(FluidValues.NUGGET * 10))
      .save(consumer, location(meltingFolder + "casting_basin"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedTable), TinkerFluids.scorchedStone, FluidValues.BRICK * 7, 2.5f)
      .addByproduct(TinkerFluids.moltenGold.result(FluidValues.NUGGET * 4))
      .save(consumer, location(meltingFolder + "casting_table"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedProxyTank), TinkerFluids.moltenObsidian, FluidValues.GLASS_PANE * 2, 2.5f)
    ...
    MeltingRecipeBuilder.melting(NoContainerIngredient.of(TinkerSmeltery.scorchedLantern), TinkerFluids.scorchedStone, FluidValues.BRICK * 2, 1.0f)
                        ...
                        .save(consumer, location(meltingFolder + "lantern"));
    // glass
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedGlass), TinkerFluids.scorchedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM))
                        .save(consumer, location(meltingFolder + "glass"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedSoulGlass), TinkerFluids.scorchedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.liquidSoul.result(FluidValues.GLASS_BLOCK))
                        .save(consumer, location(meltingFolder + "glass_soul"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedTintedGlass), TinkerFluids.scorchedStone, FluidValues.BRICK * 4, 2f)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_BLOCK))
                        .addByproduct(TinkerFluids.moltenAmethyst.result(FluidValues.GEM * 2))
                        .save(consumer, location(meltingFolder + "glass_tinted"));
    // panes
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedGlassPane), TinkerFluids.scorchedStone, FluidValues.BRICK, 1.0f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM_SHARD))
                        .save(consumer, location(meltingFolder + "pane"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedSoulGlassPane), TinkerFluids.scorchedStone, FluidValues.BRICK, 1.0f)
                        .addByproduct(TinkerFluids.liquidSoul.result(FluidValues.GLASS_PANE))
                        .save(consumer, location(meltingFolder + "pane_soul"));
    // controllers
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedAlloyer), TinkerFluids.scorchedStone, FluidValues.BRICK * 9, 3.5f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM * 5))
                        .save(consumer, location(meltingFolder + "melter"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedFluidCannon), TinkerFluids.moltenCobalt, FluidValues.INGOT * 5, 3.5f)
                        .addByproduct(TinkerFluids.scorchedStone.result(FluidValues.BRICK * 4))
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM * 5))
                        .save(consumer, location(meltingFolder + "fluid_cannon"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.foundryController), TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK, 3.5f)
                        .addByproduct(TinkerFluids.scorchedStone.result(FluidValues.BRICK * 4))
                        .save(consumer, location("smeltery/melting/obsidian/foundry_controller"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedDrain, TinkerSmeltery.scorchedChute), TinkerFluids.moltenObsidian, FluidValues.GLASS_PANE * 2, 2.5f)
                        .addByproduct(TinkerFluids.scorchedStone.result(FluidValues.BRICK * 4))
                        .save(consumer, location("smeltery/melting/obsidian/foundry_io"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.obsidianGauge), TinkerFluids.moltenObsidian, FluidValues.GLASS_PANE, 2.5f)
      .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_PANE / 5))
      .save(consumer, location("smeltery/melting/obsidian/gauge"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.scorchedDuct), TinkerFluids.moltenGold, FluidValues.INGOT * 2, 2.5f)
                        .addByproduct(TinkerFluids.scorchedStone.result(FluidValues.BRICK * 4))
  ...
  private void addCastingRecipes(RecipeOutput consumer) {
    ...
    ItemCastingRecipeBuilder.tableDuplication()
                            .setCast(CompoundIngredient.of(TinkerIngredients.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), TinkerIngredients.of(TinkerTags.Items.TRIM_TEMPLATES)), false)
    ...
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromTemplate(waterPotion(Items.POTION)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
                            .setCast(Items.GLASS_BOTTLE, true)
                            .save(consumer, location(waterFolder + "bottle"));
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromTemplate(waterPotion(Items.SPLASH_POTION)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
                            .setCast(MantleTags.Items.SPLASH_BOTTLE, true)
                            .save(consumer, location(waterFolder + "splash"));
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromTemplate(waterPotion(Items.LINGERING_POTION)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
    ...
    this.castCreation(consumer, CompoundIngredient.of(
      ...
      DifferenceIngredient.of(TinkerIngredients.of(Tags.Items.INGOTS), TinkerIngredients.of(TinkerToolParts.fakeIngot)),
      MaterialTinkerIngredients.of(TinkerToolParts.fakeIngot)
  ...
  private void addMeltingRecipes(RecipeOutput consumer) {
    ...
    // water from ice
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.ICE), Fluids.WATER, FluidType.BUCKET_VOLUME, 1.0f)
                        .save(consumer, location(folder + "water/ice"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.PACKED_ICE), Fluids.WATER, FluidType.BUCKET_VOLUME * 9, 3.0f)
                        .save(consumer, location(folder + "water/packed_ice"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.BLUE_ICE), Fluids.WATER, FluidType.BUCKET_VOLUME * 81, 9.0f)
                        .save(consumer, location(folder + "water/blue_ice"));
    // water from snow
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SNOWBALL), Fluids.WATER, FluidType.BUCKET_VOLUME / 8, 0.5f)
                        .save(consumer, location(folder + "water/snowball"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SNOW_BLOCK), Fluids.WATER, FluidType.BUCKET_VOLUME / 2, 0.75f)
                        .save(consumer, location(folder + "water/snow_block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SNOW), Fluids.WATER, FluidType.BUCKET_VOLUME / 8, 0.5f)
                        .save(consumer, location(folder + "water/snow_layer"));

    // ores
    String metalFolder = folder + "metal/";
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Tags.Items.ORES_NETHERITE_SCRAP), TinkerFluids.moltenDebris, FluidValues.INGOT, 2.0f)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerTags.Items.INGOTS_NETHERITE_SCRAP), TinkerFluids.moltenDebris, FluidValues.INGOT, 1.0f)
                        .save(consumer, location(metalFolder + "molten_debris/scrap"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerTags.Items.NUGGETS_NETHERITE_SCRAP), TinkerFluids.moltenDebris, FluidValues.NUGGET, 1 / 3f)
                        .save(consumer, location(metalFolder + "molten_debris/debris_nugget"));
    
    // venom
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SPIDER_EYE), TinkerFluids.venom, FluidValues.BOTTLE, 1.0f)
                        .save(consumer, location(folder + "venom/eye"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.FERMENTED_SPIDER_EYE), TinkerFluids.venom, FluidValues.BOTTLE * 2, 1.0f)
                        .save(consumer, location(folder + "venom/fermented_eye"));

    // glass
    MeltingRecipeBuilder.melting(TinkerIngredients.of(ItemTags.SMELTS_TO_GLASS), TinkerFluids.moltenGlass, FluidValues.GLASS_BLOCK, 1.5f)
                        .save(consumer, location(folder + "glass/sand"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerTags.Items.GLASS_BLOCKS_SILICA), TinkerFluids.moltenGlass, FluidValues.GLASS_BLOCK, 1.0f)
                        .save(consumer, location(folder + "glass/block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerTags.Items.GLASS_PANES_SILICA), TinkerFluids.moltenGlass, FluidValues.GLASS_PANE, 0.5f)
                        .save(consumer, location(folder + "glass/pane"));
    MeltingRecipeBuilder.melting(CompoundIngredient.of(TinkerIngredients.of(Items.GLASS_BOTTLE), TinkerIngredients.of(MantleTags.Items.SPLASH_BOTTLE), TinkerIngredients.of(MantleTags.Items.LINGERING_BOTTLE)),
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.blankSandCast, TinkerSmeltery.blankRedSandCast),
                                 TinkerFluids.moltenGlass, FluidValues.GLASS_PANE, 0.75f)
                        .save(consumer, location(folder + "glass/sand_cast"));

    // liquid soul
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.SOUL_SAND, Blocks.SOUL_SOIL), TinkerFluids.liquidSoul, FluidValues.GLASS_BLOCK, 1.5f)
                        .save(consumer, location(folder + "soul/sand"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.soulGlass), TinkerFluids.liquidSoul, FluidValues.GLASS_BLOCK, 1.0f)
                        .save(consumer, location(folder + "soul/glass"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.soulGlassPane), TinkerFluids.liquidSoul, FluidValues.GLASS_PANE, 0.5f)
                        .save(consumer, location(folder + "soul/pane"));

    // clay
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.CLAY), TinkerFluids.moltenClay, FluidValues.BRICK_BLOCK, 1.0f)
                        .save(consumer, location(folder + "clay/block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CLAY_BALL), TinkerFluids.moltenClay, FluidValues.BRICK, 0.5f)
                        .save(consumer, location(folder + "clay/ball"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.FLOWER_POT), TinkerFluids.moltenClay, FluidValues.BRICK * 3, 2.0f)
    ...
    // terracotta
    Ingredient terracottaBlock = TinkerIngredients.of(
    ...
    MeltingRecipeBuilder.melting(CompoundIngredient.of(TinkerIngredients.of(Items.BRICK), TinkerIngredients.of(ItemTags.DECORATED_POT_SHERDS)), TinkerFluids.moltenClay, FluidValues.BRICK, 1.0f)
                        .save(consumer, location(folder + "clay/brick"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.BRICK_SLAB),
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(SlimeType.ICHOR.getSlimeballTag()), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD, 1.0f)
                        .addByproduct(TinkerFluids.ichor.result(FluidValues.ICHOR_BYPRODUCT))
                        .save(consumer, location(ichorFolder + "ball"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.congealedSlime.get(SlimeType.ICHOR)), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD * 4, 2.0f)
                        .addByproduct(TinkerFluids.ichor.result(FluidValues.ICHOR_BYPRODUCT * 4))
                        .save(consumer, location(ichorFolder + "congealed"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.slime.get(SlimeType.ICHOR)), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD * 9, 3.0f)
                        .addByproduct(TinkerFluids.ichor.result(FluidValues.ICHOR_BYPRODUCT * 9))
                        .save(consumer, location(ichorFolder + "block"));
    // magma cream
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.MAGMA_CREAM), TinkerFluids.magma, FluidValues.SLIMEBALL, 1.0f)
                        .save(consumer, location(slimeFolder + "magma/ball"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.MAGMA_BLOCK), TinkerFluids.magma, FluidValues.SLIME_CONGEALED, 3.0f)
    ...
    MeltingRecipeBuilder.melting(
      CompoundIngredient.of(TinkerIngredients.of(Tags.Items.ENDER_PEARLS), TinkerIngredients.of(Items.ENDER_EYE)),
      TinkerFluids.moltenEnder, FluidValues.SLIMEBALL, 1.0f)
                        .save(consumer, location(folder + "ender/pearl"));

    // obsidian
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Tags.Items.OBSIDIANS), TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK, 2.0f)
                        .save(consumer, location(folder + "obsidian/block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.obsidianPane), TinkerFluids.moltenObsidian, FluidValues.GLASS_PANE, 1.5f)
                        .save(consumer, location(folder + "obsidian/pane"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.ENDER_CHEST), TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK * 8, 5.0f)
    ...
    // emerald
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.emeraldReinforcement), TinkerFluids.moltenEmerald, FluidValues.GEM_SHARD)
    ...
    // quartz
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.SMOOTH_QUARTZ, Blocks.QUARTZ_PILLAR, Blocks.QUARTZ_BRICKS, Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_STAIRS, Blocks.SMOOTH_QUARTZ_STAIRS),
      TinkerFluids.moltenQuartz, FluidValues.SMALL_GEM_BLOCK, 2.0f)
                        .save(consumer, location(folder + "quartz/decorative_block"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.QUARTZ_SLAB, Blocks.SMOOTH_QUARTZ_SLAB), TinkerFluids.moltenQuartz, FluidValues.GEM * 2, 1.5f)
                        .save(consumer, location(folder + "quartz/slab"));

    // amethyst
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.AMETHYST_CLUSTER), TinkerFluids.moltenAmethyst, FluidValues.GEM * 4, 4.0f)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.SMALL_AMETHYST_BUD), TinkerFluids.moltenAmethyst, FluidValues.GEM, 1.0f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM))
                        .setOre(OreRateType.GEM)
                        .save(consumer, location(folder + "amethyst/bud_small"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.MEDIUM_AMETHYST_BUD), TinkerFluids.moltenAmethyst, FluidValues.GEM * 2, 2.0f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM * 2))
                        .setOre(OreRateType.GEM)
                        .save(consumer, location(folder + "amethyst/bud_medium"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.LARGE_AMETHYST_BUD), TinkerFluids.moltenAmethyst, FluidValues.GEM * 3, 3.0f)
                        .addByproduct(TinkerFluids.moltenQuartz.result(FluidValues.GEM * 3))
                        .setOre(OreRateType.GEM)
                        .save(consumer, location(folder + "amethyst/bud_large"));

    // iron melting - standard values
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.ACTIVATOR_RAIL, Items.DETECTOR_RAIL, Blocks.STONECUTTER, Blocks.PISTON, Blocks.STICKY_PISTON), TinkerFluids.moltenIron, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "iron/ingot_1"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.HEAVY_WEIGHTED_PRESSURE_PLATE, Items.IRON_DOOR, Blocks.SMITHING_TABLE), TinkerFluids.moltenIron, FluidValues.INGOT * 2)
                        .save(consumer, location(metalFolder + "iron/ingot_2"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.BUCKET), TinkerFluids.moltenIron, FluidValues.INGOT * 3)
                        .save(consumer, location(metalFolder + "iron/bucket"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.COMPASS, Blocks.IRON_TRAPDOOR), TinkerFluids.moltenIron, FluidValues.INGOT * 4)
                        .save(consumer, location(metalFolder + "iron/ingot_4"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.BLAST_FURNACE, Blocks.HOPPER, Items.MINECART), TinkerFluids.moltenIron, FluidValues.INGOT * 5)
                        .save(consumer, location(metalFolder + "iron/ingot_5"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.CAULDRON), TinkerFluids.moltenIron, FluidValues.INGOT * 7)
                        .save(consumer, location(metalFolder + "iron/cauldron"));
    // non-standard
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.IRON_CHAIN), TinkerFluids.moltenIron, FluidValues.INGOT + FluidValues.NUGGET * 2)
                        .save(consumer, location(metalFolder + "iron/chain"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.ANVIL, Blocks.CHIPPED_ANVIL, Blocks.DAMAGED_ANVIL), TinkerFluids.moltenIron, FluidValues.INGOT * 4 + FluidValues.METAL_BLOCK * 3)
                        .save(consumer, location(metalFolder + "iron/anvil"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.IRON_BARS, Blocks.RAIL), TinkerFluids.moltenIron, FluidValues.NUGGET * 3)
                        .save(consumer, location(metalFolder + "iron/nugget_3"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.ironPlatform), TinkerFluids.moltenIron, FluidValues.NUGGET * 10)
                        .save(consumer, location(metalFolder + "iron/platform"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.TRIPWIRE_HOOK), TinkerFluids.moltenIron, FluidValues.NUGGET * 4)
                        .save(consumer, location(metalFolder + "iron/tripwire"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.LANTERN, Blocks.SOUL_LANTERN), TinkerFluids.moltenIron, FluidValues.NUGGET * 8)
                        .save(consumer, location(metalFolder + "iron/lantern"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.ironReinforcement), TinkerFluids.moltenIron, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "iron/reinforcement"));
    // tools
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CROSSBOW), TinkerFluids.moltenIron, FluidValues.NUGGET * 13) // tripwire hook is 4 nuggets, ingot is 9 nuggets
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CHAINMAIL_HELMET), TinkerFluids.moltenIron, chainIron * 5)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CHAINMAIL_CHESTPLATE), TinkerFluids.moltenIron, chainIron * 8)
                        .addByproduct(TinkerFluids.moltenSteel.result(chainSteel * 8))
                        .setDamagable(FluidValues.NUGGET, FluidValues.NUGGET)
                        .save(consumer, location(metalFolder + "iron/chain_chestplate"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CHAINMAIL_LEGGINGS), TinkerFluids.moltenIron, chainIron * 7)
                        .addByproduct(TinkerFluids.moltenSteel.result(chainSteel * 7))
                        .setDamagable(FluidValues.NUGGET, FluidValues.NUGGET)
                        .save(consumer, location(metalFolder + "iron/chain_leggings"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CHAINMAIL_BOOTS), TinkerFluids.moltenIron, chainIron * 4)
    ...
    // gold melting
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerTags.Items.GOLD_CASTS), TinkerFluids.moltenGold, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "gold/cast"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.POWERED_RAIL), TinkerFluids.moltenGold, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "gold/powered_rail"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE), TinkerFluids.moltenGold, FluidValues.INGOT * 2)
                        .save(consumer, location(metalFolder + "gold/pressure_plate"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CLOCK), TinkerFluids.moltenGold, FluidValues.INGOT * 4)
                        .save(consumer, location(metalFolder + "gold/clock"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.GOLDEN_APPLE), TinkerFluids.moltenGold, FluidValues.INGOT * 8)
                        .save(consumer, location(metalFolder + "gold/apple"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.GLISTERING_MELON_SLICE, Items.GOLDEN_CARROT), TinkerFluids.moltenGold, FluidValues.NUGGET * 8)
                        .save(consumer, location(metalFolder + "gold/produce"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.goldReinforcement), TinkerFluids.moltenGold, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "gold/reinforcement"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.goldBars), TinkerFluids.moltenGold, FluidValues.NUGGET * 3)
                        .save(consumer, location(metalFolder + "gold/nugget_3"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.goldPlatform), TinkerFluids.moltenGold, FluidValues.NUGGET * 10)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.NETHER_GOLD_ORE), TinkerFluids.moltenGold, FluidValues.INGOT)
                        .addByproduct(TinkerFluids.moltenCopper.result(FluidValues.INGOT))
                        .setOre(OreRateType.METAL)
                        .save(consumer, location(metalFolder + "gold/nether_gold_ore"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.GILDED_BLACKSTONE), TinkerFluids.moltenGold, FluidValues.NUGGET * 3) // bit below average, ore rate will bring you bit above average
                        .addByproduct(TinkerFluids.moltenCopper.result(FluidValues.INGOT))
                        .setOre(OreRateType.METAL)
                        .save(consumer, location(metalFolder + "gold/gilded_blackstone"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.BELL), TinkerFluids.moltenGold, FluidValues.INGOT * 4) // bit arbitrary, I am happy to change the value if someone has a better one
    ...
    // amethyst melting
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.TINTED_GLASS, TinkerCommons.clearTintedGlass), TinkerFluids.moltenAmethyst, FluidValues.GEM * 2)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SPYGLASS), TinkerFluids.moltenAmethyst, FluidValues.GEM)
                        .addByproduct(TinkerFluids.moltenCopper.result(FluidValues.INGOT * 2))
                        .save(consumer, location(folder + "amethyst/spyglass"));

    // diamond melting
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.JUKEBOX), TinkerFluids.moltenDiamond, FluidValues.GEM)
                        .save(consumer, location(folder + "diamond/jukebox"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.ENCHANTING_TABLE), TinkerFluids.moltenDiamond, FluidValues.GEM * 2)
    ...
    MeltingRecipeBuilder.melting(CompoundIngredient.of(TinkerIngredients.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), TinkerIngredients.of(TinkerTags.Items.TRIM_TEMPLATES)), TinkerFluids.moltenDiamond, FluidValues.GEM * 5)
                        .save(consumer, location(folder + "diamond/smithing_template"));
    // unique melting
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.NETHERITE_CHESTPLATE), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(getItemTag(TConstruct.MOD_ID, "melting/netherite/tools_costing_" + 7)), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
                        .addByproduct(TinkerFluids.moltenDiamond.result(FluidValues.GEM * 7))
                        .save(consumer, location(metalFolder + "netherite/leggings"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.NETHERITE_BOOTS), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(getItemTag(TConstruct.MOD_ID, "melting/netherite/tools_costing_" + 3)), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(getItemTag(TConstruct.MOD_ID, "melting/netherite/tools_costing_" + 2)), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(getItemTag(TConstruct.MOD_ID, "melting/netherite/tools_costing_" + 1)), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(Identifier.fromNamespaceAndPath("tools_complement", "netherite_excavator")), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        ...
                        .save(withCondition(consumer, NeoForgeConditions.itemRegistered(Identifier.fromNamespaceAndPath("tools_complement", "netherite_excavator"))), location(metalFolder + "netherite/excavator"));
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(Identifier.fromNamespaceAndPath("tools_complement", "netherite_hammer")), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        ...
                        .save(withCondition(consumer, NeoForgeConditions.itemRegistered(Identifier.fromNamespaceAndPath("tools_complement", "netherite_hammer"))), location(metalFolder + "netherite/hammer"));

    // quartz
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.OBSERVER, Blocks.COMPARATOR, TinkerGadgets.quartzShuriken), TinkerFluids.moltenQuartz, FluidValues.GEM)
                        .save(consumer, location(folder + "quartz/gem_1"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.DAYLIGHT_DETECTOR), TinkerFluids.moltenQuartz, FluidValues.GEM * 3)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_BLOCK * 3))
                        .save(consumer, location(folder + "quartz/daylight_detector"));

    // obsidian, if you are crazy i guess
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Blocks.BEACON), TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK * 3)
                        .addByproduct(TinkerFluids.moltenGlass.result(FluidValues.GLASS_BLOCK * 5))
                        .save(consumer, location(folder + "obsidian/beacon"));

    // knightmetal recycling
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerSmeltery.endFluidCannon), TinkerFluids.moltenKnightmetal, FluidValues.INGOT * 5, 2.5f)
      .save(consumer, location(folder + "metal/knightmetal/fluid_cannon"));

    // ender
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.END_CRYSTAL), TinkerFluids.moltenEnder, FluidValues.SLIMEBALL)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.silkyCloth), TinkerFluids.moltenRoseGold, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "rose_gold/silky_cloth"));

    // durability reinforcements
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.slimesteelReinforcement), TinkerFluids.moltenSlimesteel, FluidValues.NUGGET * 3)
                        .addByproduct(TinkerFluids.moltenObsidian.result(FluidValues.GLASS_PANE))
                        .save(consumer, location(metalFolder + "slimesteel/reinforcement"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.obsidianReinforcement), TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK)
                        .save(consumer, location(metalFolder + "obsidian/reinforcement"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerModifiers.cobaltReinforcement), TinkerFluids.moltenCobalt, FluidValues.INGOT)
                        .save(consumer, location(metalFolder + "cobalt/reinforcement"));

    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerCommons.cobaltPlatform), TinkerFluids.moltenCobalt, FluidValues.NUGGET * 10)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.ichorGeode), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD, 1.0f)
                        .addByproduct(TinkerFluids.ichor.result(FluidValues.ICHOR_BYPRODUCT))
                        .save(consumer, location(slimeFolder + "ichor/crystal"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.ichorGeode.getBlock()), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD * 4, 2.0f)
                        .addByproduct(TinkerFluids.ichor.result(FluidValues.ICHOR_BYPRODUCT * 4))
                        .save(consumer, location(slimeFolder + "ichor/crystal_block"));
    for (BudSize bud : BudSize.values()) {
      int size = bud.getSize();
      MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.ichorGeode.getBud(bud)), TinkerFluids.blazingBlood, FluidValues.ICHOR_BLAZING_BLOOD * size, (size + 1) / 2f)
    ...
    // clusters
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.steelCluster), TinkerFluids.moltenSteel, FluidValues.NUGGET * 4, 5/2f)
      .save(consumer, location(folder + "metal/steel/cluster"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.cobaltCluster), TinkerFluids.moltenCobalt, FluidValues.NUGGET * 4, 5/2f)
      .save(consumer, location(folder + "metal/cobalt/cluster"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.knightmetalCluster), TinkerFluids.moltenKnightmetal, FluidValues.NUGGET * 4, 5/2f)
      .save(consumer, location(folder + "metal/knightmetal/cluster"));

    // recycle saplings
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.slimeSapling.get(FoliageType.EARTH)), TinkerFluids.earthSlime, FluidValues.SLIMEBALL)
                        .save(consumer, location(slimeFolder + "earth/sapling"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.slimeSapling.get(FoliageType.SKY)), TinkerFluids.skySlime, FluidValues.SLIMEBALL)
                        .save(consumer, location(slimeFolder + "sky/sapling"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.slimeSapling.get(FoliageType.ENDER)), TinkerFluids.enderSlime, FluidValues.SLIMEBALL)
                        .save(consumer, location(slimeFolder + "ender/sapling"));

    // honey
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.HONEY_BLOCK), TinkerFluids.honey, FluidValues.BOTTLE * 4)
                        .save(consumer, location(slimeFolder + "honey_block"));
    // soup
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.BEETROOT), TinkerFluids.beetrootSoup, FluidValues.BOTTLE / 5, 1)
                        .save(consumer, location(slimeFolder + "beetroot_soup"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Tags.Items.MUSHROOMS), TinkerFluids.mushroomStew, FluidValues.BOTTLE / 2, 1)
  ...
  private void addAlloyRecipes(RecipeOutput consumer) {
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenObsidian, FluidValues.GLASS_BLOCK / 10)
                      .addCatalyst(FluidTinkerIngredients.of(Fluids.WATER, FluidValues.BOTTLE))
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenLumium, FluidValues.INGOT * 4)
                      .addInput(TinkerFluids.moltenTin.ingredient(FluidValues.INGOT * 3))
                      .addInput(TinkerFluids.moltenSilver.ingredient(FluidValues.INGOT))
                      .addInput(FluidTinkerIngredients.of(fluidTag.apply("glowstone"), FluidValues.SLIMEBALL * 2))
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenSignalum, FluidValues.INGOT * 4)
                      .addInput(TinkerFluids.moltenCopper.ingredient(FluidValues.INGOT * 3))
                      .addInput(TinkerFluids.moltenSilver.ingredient(FluidValues.INGOT))
                      .addInput(FluidTinkerIngredients.of(fluidTag.apply("redstone"), 400))
  ...
  private void addEntityMeltingRecipes(RecipeOutput consumer) {
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.ZOMBIE_HEAD, TinkerWorld.heads.get(TinkerHeadType.HUSK)), TinkerFluids.moltenIron, FluidValues.INGOT)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.heads.get(TinkerHeadType.DROWNED)), TinkerFluids.moltenCopper, FluidValues.INGOT)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.PIGLIN_HEAD, TinkerWorld.heads.get(TinkerHeadType.PIGLIN_BRUTE), TinkerWorld.heads.get(TinkerHeadType.ZOMBIFIED_PIGLIN)), TinkerFluids.moltenGold, FluidValues.INGOT)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.heads.get(TinkerHeadType.SPIDER), TinkerWorld.heads.get(TinkerHeadType.CAVE_SPIDER)), TinkerFluids.venom, FluidValues.SLIMEBALL * 2)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.CREEPER_HEAD), TinkerFluids.moltenGlass, FluidType.BUCKET_VOLUME / 4)
    ...
    EntityMeltingRecipeBuilder.melting(EntityIngredient.of(EntityIngredient.of(TinkerTags.EntityTypes.GHASTS), EntityIngredient.of(TinkerTags.EntityTypes.AXOLOTLS)), PotionFluidType.potionResult(Potions.REGENERATION, FluidValues.BOTTLE / 5), 2)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.SKELETON_SKULL, Items.WITHER_SKELETON_SKULL, TinkerWorld.heads.get(TinkerHeadType.STRAY)), NeoForgeMod.MILK.get(), FluidType.BUCKET_VOLUME / 4)
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.heads.get(TinkerHeadType.BLAZE)), TinkerFluids.blazingBlood.result(FluidType.BUCKET_VOLUME / 10), 1000, IMeltingRecipe.calcTime(1500, 1.0f))
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(TinkerWorld.heads.get(TinkerHeadType.ENDERMAN)), TinkerFluids.moltenEnder, FluidValues.SLIMEBALL * 2)
                        .save(consumer, location(headFolder + "enderman"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(Items.DRAGON_HEAD), TinkerFluids.moltenEnder, FluidValues.SLIMEBALL * 4)
  ...
  private void addTagRecipes(RecipeOutput consumer) {
    ...
    fluid(consumer, "fiery", TinkerFluids.fieryLiquid).optional()
      ...
      .blockCasting(9, TinkerIngredients.of(Tags.Items.STORAGE_BLOCKS_IRON), false)
  ...
  private void addCompatRecipes(RecipeOutput consumer) {
    ...
    Function<String,Ingredient> ceramicsTag = name -> TinkerIngredients.of(ItemTags.create(Identifier.fromNamespaceAndPath(ceramics, name)));
  ...
  private void searedStonecutter(RecipeOutput consumer, ItemLike output, String folder) {
    SingleItemRecipeBuilder.stonecutting(
      CompoundIngredient.of(
        TinkerIngredients.of(TinkerSmeltery.searedStone),
        DifferenceIngredient.of(TinkerIngredients.of(TinkerTags.Items.SEARED_BRICKS), TinkerIngredients.of(output))), RecipeCategory.BUILDING_BLOCKS, output, 1)
  ...
  private void scorchedStonecutter(RecipeOutput consumer, ItemLike output, String folder) {
    SingleItemRecipeBuilder.stonecutting(DifferenceIngredient.of(TinkerIngredients.of(TinkerTags.Items.SCORCHED_BLOCKS), TinkerIngredients.of(output)), RecipeCategory.BUILDING_BLOCKS, output, 1)
  ...
  private void slimeMelting(RecipeOutput consumer, FluidObject<?> fluid, SlimeType type, String folder) {
    ...
    MeltingRecipeBuilder.melting(TinkerIngredients.of(type.getSlimeballTag()), fluid, FluidValues.SLIMEBALL, 1.0f)
                        .save(consumer, location(slimeFolder + "ball"));
    ItemLike item = TinkerWorld.congealedSlime.get(type);
    MeltingRecipeBuilder.melting(TinkerIngredients.of(item), fluid, FluidValues.SLIME_CONGEALED, 2.0f)
                        .save(consumer, location(slimeFolder + "congealed"));
    item = TinkerWorld.slime.get(type);
    MeltingRecipeBuilder.melting(TinkerIngredients.of(item), fluid, FluidValues.SLIME_BLOCK, 3.0f)
  ...
  private static ItemStackTemplate waterPotion(ItemLike item) {
  ...
  private void crystalMelting(RecipeOutput consumer, GeodeItemObject geode, FluidObject<?> fluid, String folder) {
    MeltingRecipeBuilder.melting(TinkerIngredients.of(geode), fluid, FluidValues.SLIMEBALL, 1.0f).save(consumer, location(folder + "crystal"));
    MeltingRecipeBuilder.melting(TinkerIngredients.of(geode.getBlock()), fluid, FluidValues.SLIMEBALL * 4, 2.0f).save(consumer, location(folder + "crystal_block"));
    for (BudSize bud : BudSize.values()) {
      int size = bud.getSize();
      MeltingRecipeBuilder.melting(TinkerIngredients.of(geode.getBud(bud)), fluid, FluidValues.SLIMEBALL * size, (size + 1) / 2f)
                          .setOre(OreRateType.GEM)
