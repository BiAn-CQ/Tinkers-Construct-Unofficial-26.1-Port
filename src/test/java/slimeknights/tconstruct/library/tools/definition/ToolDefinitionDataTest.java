...
class ToolDefinitionDataTest extends BaseMcTest {
  ...
  void actions_canPerform() {
    ...
    assertThat(ToolDefinitionData.EMPTY.getHook(ToolHooks.TOOL_ACTION).canPerformAction(context, TinkerToolActions.SWORD_DIG)).isFalse();
    ...
    assertThat(newData.getHook(ToolHooks.TOOL_ACTION).canPerformAction(context, TinkerToolActions.SWORD_DIG)).isFalse();
  }
}
