...
class StationSlotLayoutLoaderTest extends BaseMcTest {
  ...
  void minimal_withTool() {
    Map<Identifier,JsonElement> splashList = fileLoader.loadFilesAsSplashlist("minimal_with_tool");
    StationSlotLayoutLoader.getInstance().apply(splashList, mock(ResourceManager.class), mock(ProfilerFiller.class));
  ...
  private static void ingredientIsItem(Ingredient ingredient, Item item) {
    assertThat(ingredient.test(new ItemStack(item))).isTrue();
  }
  ...
  void tooFewSlots_defaults() {
    Map<Identifier,JsonElement> splashList = fileLoader.loadFilesAsSplashlist("too_few_slots");
    StationSlotLayoutLoader.getInstance().apply(splashList, mock(ResourceManager.class), mock(ProfilerFiller.class));
  ...
  void tooFewSlots_withTool_defaults() {
    Map<Identifier,JsonElement> splashList = fileLoader.loadFilesAsSplashlist("too_few_slots_with_tool");
    StationSlotLayoutLoader.getInstance().apply(splashList, mock(ResourceManager.class), mock(ProfilerFiller.class));
