...
class MaterialTraitsManagerTest extends BaseMcTest {
  ...
  private final TestMaterialTraitsManager traitsManager = new TestMaterialTraitsManager();
  private final MergingJsonFileLoader<MaterialTraits.Builder> fileLoader = new MergingJsonFileLoader<>(traitsManager);

  private static class TestMaterialTraitsManager extends MaterialTraitsManager implements MergingJsonTestAdapter<MaterialTraits.Builder> {
    TestMaterialTraitsManager() {
      super(() -> {});
    }
    ...
    @Override
    public Function<Identifier,MaterialTraits.Builder> builderConstructorForTest() {
      return builderConstructor;
    }

    @Override
    public void parseForTest(MaterialTraits.Builder builder, Identifier id, JsonElement element) {
      parse(builder, id, element);
    }

    @Override
    public void finishLoadForTest(Map<Identifier,MaterialTraits.Builder> map, ResourceManager manager) {
